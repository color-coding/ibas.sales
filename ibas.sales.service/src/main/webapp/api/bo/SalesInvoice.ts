...
namespace sales {
    export namespace bo {
        /** 销售发票 */
        export interface ISalesInvoice extends ibas.IBODocument, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 单据编码 */
            docNum: string;
        ...
        /** 销售发票-行 集合 */
        export interface ISalesInvoiceItems extends ibas.IBusinessObjects<ISalesInvoiceItem> {
            /** 创建并添加子项 */
            create(): ISalesInvoiceItem;
        }
        /** 销售发票-预收款 集合 */
        export interface ISalesInvoiceDownPayments extends ibas.IBusinessObjects<ISalesInvoiceDownPayment> {
            /** 创建并添加子项 */
        ...
        /** 销售发票-预收款 */
        export interface ISalesInvoiceDownPayment extends ibas.IBODocumentLine {
            /** 凭证编号 */
            docEntry: number;
            /** 行号 */
            lineId: number;
