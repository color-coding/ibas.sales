...
namespace sales {
    export namespace bo {
        ...
        /** 销售订单-行-额外信息 集合 */
        export interface ISalesOrderItemExtras extends ibas.IBusinessObjects<ISalesOrderItemExtra> {
            /** 创建并添加子项 */
            create(): ISalesOrderItemExtra;
        }

        /** 销售订单-行-额外信息 */
        export interface ISalesOrderItemExtra extends ibas.IBODocumentLine {
            /** 编码 */
            docEntry: number;
            /** 行号 */
            lineId: number;
