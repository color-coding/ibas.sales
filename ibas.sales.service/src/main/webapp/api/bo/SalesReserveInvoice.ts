...
namespace sales {
    export namespace bo {
        /** 销售预留发票 */
        export interface ISalesReserveInvoice extends ibas.IBODocument, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 单据编码 */
            docNum: string;
        ...
        /** 销售预留发票-行 集合 */
        export interface ISalesReserveInvoiceItems extends ibas.IBusinessObjects<ISalesReserveInvoiceItem> {
            /** 创建并添加子项 */
            create(): ISalesReserveInvoiceItem;
        }

        /** 销售预留发票-行 */
        export interface ISalesReserveInvoiceItem extends ibas.IBODocumentLine, materials.bo.IMaterialBatchItemParent, materials.bo.IMaterialSerialItemParent, ibas.IBOUserFields {
            /** 编码 */
            docEntry: number;
            /** 行号 */
            lineId: number;
