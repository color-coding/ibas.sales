...
namespace sales {
    export namespace bo {
        /** 销售贷项 */
        export interface ISalesCreditNote extends ibas.IBODocument, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 单据编码 */
            docNum: string;
        ...
        /** 销售贷项-行 集合 */
        export interface ISalesCreditNoteItems extends ibas.IBusinessObjects<ISalesCreditNoteItem> {
            /** 创建并添加子项 */
            create(): ISalesCreditNoteItem;
        }

        /** 销售贷项-行 */
        export interface ISalesCreditNoteItem extends ibas.IBODocumentLine, ibas.IBOUserFields {
            /** 编码 */
            docEntry: number;
            /** 行号 */
            lineId: number;
