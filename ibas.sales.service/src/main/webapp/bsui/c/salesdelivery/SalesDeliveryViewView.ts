    ...
    export namespace ui {
        export namespace c {
            ...
            export class SalesDeliveryViewView extends ibas.BOViewView implements app.ISalesDeliveryViewView {
                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        headerContent: [
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    new sap.extension.m.RepositoryObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesdelivery_contactperson"),
                                        bindingValue: {
                                            path: "contactPerson",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
                            ...
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    ...
                                    */
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesdelivery_agreements"),
                                        bindingValue: {
                                            path: "agreements",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                            ...
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesdelivery_documenttaxtotal"),
                                        bindingValue: {
                                            parts: [
                                                {
                                                    path: "itemsTaxTotal",
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesdelivery_shippingsexpensetotal"),
                                        bindingValue: {
                                            parts: [
                                                {
                ...
                private tableSalesDeliveryItem: sap.extension.m.Table;
