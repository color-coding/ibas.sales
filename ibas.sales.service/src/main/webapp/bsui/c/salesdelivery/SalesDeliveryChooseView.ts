...
namespace sales {
    export namespace ui {
        export namespace c {
             ...
             * 选择视图-销售交货
             */
            export class SalesDeliveryChooseView extends ibas.BOQueryDialogViewWithPanel implements app.ISalesDeliveryChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    this.itemTable = new sap.extension.m.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesdeliveryitem_itemcode"),
                                width: "10rem",
                            }),
                            new sap.extension.m.Column("", {
                            ...
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesdeliveryitem_warehouse"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesdeliveryitem_quantity"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesdeliveryitem_price"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesdeliveryitem_linetotal"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesdeliveryitem_reference1"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesdeliveryitem_reference2"),
                            }),
                        ],
                        items: {
                            path: "/",
                                                    ...
                                                    menu: new sap.m.Menu("", {
                                                        items: [
                                                            this.customMenuItem = new sap.m.MenuItem("", {
                                                                ...
                                                                press: function (): void {
                                                                    let selecteds: ibas.IList<bo.SalesDelivery> = that.table.getSelecteds();
                ...
                showDataItems(datas: bo.SalesDelivery[]): void {
                    this.container.to(this.itemTable.getParent().getId());
                    let dataItems: ibas.IList<bo.SalesDeliveryItem> = new ibas.ArrayList<bo.SalesDeliveryItem>();
