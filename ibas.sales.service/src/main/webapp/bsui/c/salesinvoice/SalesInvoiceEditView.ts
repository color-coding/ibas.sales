                ...
                draw(): any {
                    ...
                    let formTop: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", {
                                text: ibas.i18n.prop("bo_salesinvoice_cancellationdate"),
                                visible: {
                                    path: "canceled",
                                    formatter(data: any): any {
                            ...
                            new sap.extension.m.DatePicker("", {
                                change(event: sap.ui.base.Event): void {
                                    ...
                                    if (source instanceof sap.m.DatePicker) {
                                        ...
                                        if (data instanceof bo.SalesInvoice && !ibas.strings.isEmpty(data.paymentCode)) {
                            ...
                            new sap.m.Label("", {
                                visible: false,
                                text: ibas.i18n.prop("bo_salesinvoice_postingdate"),
                            }),
                            new sap.extension.m.DatePicker("", {
                                visible: false,
                            }).bindProperty("bindingValue", {
                            ...
                            new sap.m.Label("", {
                                visible: false,
                                text: ibas.i18n.prop("bo_salesinvoice_consumer")
                            }),
                            new sap.extension.m.Input("", {
                                visible: false,
                            }).bindProperty("bindingValue", {
                    ...
                    let formBottom: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_salesinvoice_rounding") }),
                            new sap.m.FlexBox("", {
                                width: "100%",
                                justifyContent: sap.m.FlexJustifyContent.Start,
                                renderType: sap.m.FlexRendertype.Bare,
