...
export class ProductSuitListView extends ibas.BOListView implements IProductSuitListView {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.ProductSuit>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.ProductSuit>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.ProductSuit[] {
        return utils.getTableSelecteds<bo.ProductSuit>(this.table);
    }
}
