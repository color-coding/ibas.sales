 ...
 * 列表视图-销售退货
 */
export class SalesReturnListView extends ibas.BOListView implements ISalesReturnListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.SalesReturn>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.SalesReturn>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.SalesReturn[] {
        return utils.getTableSelecteds<bo.SalesReturn>(this.table);
    }
}
