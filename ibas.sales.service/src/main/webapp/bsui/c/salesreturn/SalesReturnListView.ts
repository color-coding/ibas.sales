...
namespace sales {
    export namespace ui {
        export namespace c {
             ...
             * 列表视图-销售退货
             */
            export class SalesReturnListView extends ibas.BOListView implements app.ISalesReturnListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreturn_printed"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "printed",
                                    type: new sap.extension.data.YesNo(true)
                            ...
                            content: [
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (event: sap.ui.base.Event): void {
                                        ...
                                        for (let item of that.table.getSelecteds<bo.SalesReturn>()) {
                                            criteria.result++;
                                            condition = criteria.conditions.create();
                                            if (criteria.conditions.length > 1) {
                                                condition.relationship = ibas.emConditionRelationship.OR;
                                            }
                                            condition.alias = bo.SalesReturn.PROPERTY_DOCENTRY_NAME;
