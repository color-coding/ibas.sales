                ...
                draw(): any {
                            ...
                            new sap.m.FlexBox("", {
                                ...
                                items: [
                                    ...
                                    new sap.extension.m.CheckBox("", {
                                        text: ibas.i18n.prop("bo_salesreturn_printed"),
                                        editable: false,
                                    }).bindProperty("bindingValue", {
                                        path: "printed",
                                        type: new sap.extension.data.YesNo()
                        ...
                        content: [
                            ...
                            this.tableSalesReturnItem = new sap.extension.table.DataTable("", {
                                ...
                                columns: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_salesreturnitem_pretaxprice"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpOnly: false,
                                            valueHelpIconSrc: "sap-icon://time-overtime",
                    ...
                    let formBottom: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturn_rounding") }),
                            new sap.m.FlexBox("", {
                                width: "100%",
                                justifyContent: sap.m.FlexJustifyContent.Start,
                                renderType: sap.m.FlexRendertype.Bare,
