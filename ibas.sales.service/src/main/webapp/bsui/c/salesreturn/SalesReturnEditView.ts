...
export class SalesReturnEditView extends ibas.BOEditView implements ISalesReturnEditView {
    ...
    darw(): any {
        ...
        this.form.addContent(new sap.ui.core.Title("", { text: ibas.i18n.prop("bo_salesreturnitem") }));
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.removeSalesReturnItemEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.SalesReturnItem>(that.tableSalesReturnItem)
                            );
                        }
                    })
                ]
        ...
        this.form.addContent(this.tableSalesReturnItem);
