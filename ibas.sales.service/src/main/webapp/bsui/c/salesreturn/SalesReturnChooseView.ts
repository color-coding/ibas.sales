...
namespace sales {
    export namespace ui {
        export namespace c {
             ...
             * 选择视图-销售退货
             */
            export class SalesReturnChooseView extends ibas.BOChooseView implements app.ISalesReturnChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    // 列表加载自定义字段
                    openui5.utils.loadUserFields(this.table, bo.SalesReturn.BUSINESS_OBJECT_CODE, true);
