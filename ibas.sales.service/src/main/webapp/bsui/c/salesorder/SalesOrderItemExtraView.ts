                        ...
                        toolbar: new sap.m.Toolbar("", {
                            content: [
                                    ...
                                    menu: new sap.m.Menu("", {
                                        items: [
                                            ...
                                            new sap.m.MenuItem("", {
                                                ...
                                                press: function (): void {
                                                    that.fireViewEvents(that.addSalesOrderItemExtraEvent, materials.bo.MaterialVersion.BUSINESS_OBJECT_CODE);
                                                }
                                            }),
                                            */
                                            new sap.m.MenuItem("", {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    icon: "sap-icon://less",
                                    press: function (): void {
                                        that.fireViewEvents(that.removeSalesOrderItemExtraEvent, that.table.getSelecteds());
                                    }
                                }),
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        that.fireViewEvents(that.deleteSalesOrderItemExtraEvent, that.table.getSelecteds().firstOrDefault());
                                    }
                                }),
