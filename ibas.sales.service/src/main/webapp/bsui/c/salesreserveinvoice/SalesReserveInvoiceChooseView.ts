...
namespace sales {
    export namespace ui {
        export namespace c {
             ...
             * 选择视图-销售预留发票
             */
            export class SalesReserveInvoiceChooseView extends ibas.BOQueryDialogViewWithPanel implements app.ISalesReserveInvoiceChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.SalesReserveInvoice;
                }
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_docentry"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_approvalstatus"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "approvalStatus",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_canceled"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "canceled",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_documentstatus"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "documentStatus",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_customercode"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "customerCode",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_customername"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "customerName",
                                    type: new sap.extension.data.Alphanumeric()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_documentdate"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "documentDate",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_deliverydate"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "deliveryDate",
                                    type: new sap.extension.data.Date()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_documenttotal"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "documentTotal",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_paidtotal"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "paidTotal",
                                    type: new sap.extension.data.Sum()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_documentcurrency"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_ordertype"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_dataowner"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_reference1"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "reference1",
                                    type: new sap.extension.data.Alphanumeric()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreserveinvoice_reference2"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "reference2",
                                    type: new sap.extension.data.Alphanumeric()
                    ...
                    this.itemTable = new sap.extension.m.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_lineid"),
                                width: "6rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_itemcode"),
                                width: "10rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_itemdescription"),
                                width: "14rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_warehouse"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_quantity"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_price"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_linetotal"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_reference1"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesreserveinvoiceitem_reference2"),
                            }),
                        ],
                        items: {
                            path: "/",
                                                    ...
                                                    menu: new sap.m.Menu("", {
                                                        items: [
                                                            this.customMenuItem = new sap.m.MenuItem("", {
                                                                ...
                                                                press: function (): void {
                                                                    let selecteds: ibas.IList<bo.SalesReserveInvoice> = that.table.getSelecteds();
                                        ...
                                        footer: new sap.m.Toolbar("", {
                                            content: [
                                                ...
                                                new sap.m.Button("", {
                                                    ...
                                                    type: sap.m.ButtonType.Default,
                                                    press: function (): void {
                                                        let selectItems: bo.SalesReserveInvoiceItem[] = that.itemTable.getSelecteds();
                                                        if (selectItems.length > 0) {
                                                            let selects: bo.SalesReserveInvoice[] = that.table.getSelecteds();
                                                            for (let select of selects) {
                                                                let has: boolean = false;
                                                                for (let i: number = select.salesReserveInvoiceItems.length - 1; i >= 0; i--) {
                                                                    let item: any = select.salesReserveInvoiceItems[i];
                                                                    if (selectItems.find(c => c === item)) {
                                                                        has = true;
                                                                        continue;
                                                                    }
                                                                    select.salesReserveInvoiceItems.removeAt(i);
                                                                }
                                                                if (has === false) {
                                                                    select.markDeleted();
                                                                }
                ...
                showDataItems(datas: bo.SalesReserveInvoice[]): void {
                    this.container.to(this.itemTable.getParent().getId());
                    let dataItems: ibas.IList<bo.SalesReserveInvoiceItem> = new ibas.ArrayList<bo.SalesReserveInvoiceItem>();
                    for (let item of datas) {
                        dataItems.add(item.salesReserveInvoiceItems);
                    }
