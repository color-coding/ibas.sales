...
namespace sales {
    export namespace ui {
        export namespace c {
             ...
             * 选择视图-销售退货请求
             */
            export class SalesReturnRequestChooseView extends ibas.BOQueryDialogViewWithPanel implements app.ISalesReturnRequestChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                                                    ...
                                                    menu: new sap.m.Menu("", {
                                                        items: [
                                                            this.customMenuItem = new sap.m.MenuItem("", {
                                                                ...
                                                                press: function (): void {
                                                                    let selecteds: ibas.IList<bo.SalesReturnRequest> = that.table.getSelecteds();
                                                    ...
                                                    search(event: sap.ui.base.Event): void {
                                                        ...
                                                        if (source instanceof sap.m.SearchField) {
                                                            ...
                                                            let cCriteria: ibas.IChildCriteria = criteria.childCriterias.firstOrDefault(
                                                                c => c.propertyPath === bo.SalesReturnRequest.PROPERTY_SALESRETURNREQUESTITEMS_NAME
                                                            );
                ...
                showDataItems(datas: bo.SalesReturnRequest[]): void {
                    this.container.to(this.itemTable.getParent().getId());
                    let dataItems: ibas.IList<bo.SalesReturnRequestItem> = new ibas.ArrayList<bo.SalesReturnRequestItem>();
                    for (let item of datas) {
                        dataItems.add(item.salesReturnRequestItems);
                    }
