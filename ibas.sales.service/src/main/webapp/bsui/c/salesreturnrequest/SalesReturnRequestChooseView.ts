                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_salesreturnrequest_documentcurrency"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                        ...
                                        footer: new sap.m.Toolbar("", {
                                            content: [
                                                ...
                                                new sap.m.Button("", {
                                                    ...
                                                    type: sap.m.ButtonType.Default,
                                                    press: function (): void {
                                                        let selectItems: bo.SalesReturnRequestItem[] = that.itemTable.getSelecteds();
                                                        if (selectItems.length > 0) {
                                                            let selects: bo.SalesReturnRequest[] = that.table.getSelecteds();
                                                            for (let select of selects) {
                                                                let has: boolean = false;
                                                                for (let i: number = select.salesReturnRequestItems.length - 1; i >= 0; i--) {
                                                                    let item: any = select.salesReturnRequestItems[i];
                                                                    if (selectItems.find(c => c === item)) {
                                                                        has = true;
                                                                        continue;
                                                                    }
                                                                    select.salesReturnRequestItems.removeAt(i);
                                                                }
                                                                if (has === false) {
                                                                    select.markDeleted();
                                                                }
