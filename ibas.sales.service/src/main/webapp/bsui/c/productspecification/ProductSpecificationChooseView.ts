...
namespace sales {
    export namespace ui {
        export namespace c {
            /** 选择视图-产品规格 */
            export class ProductSpecificationChooseView extends ibas.BOChooseView implements app.IProductSpecificationChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_productspecification_specification"),
                                template: new sap.extension.m.RepositoryText("", {
                                    repository: bo.BORepositorySales,
                                    dataInfo: {
