                ...
                draw(): any {
                    ...
                    this.itemTable = new sap.extension.m.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_salesquoteitem_itemcode"),
                                width: "10rem",
                            }),
                            new sap.extension.m.Column("", {
                                        ...
                                        footer: new sap.m.Toolbar("", {
                                            content: [
                                                ...
                                                new sap.m.Button("", {
                                                    ...
                                                    type: sap.m.ButtonType.Default,
                                                    press: function (): void {
                                                        let selectItems: bo.SalesQuoteItem[] = that.itemTable.getSelecteds();
                                                        if (selectItems.length > 0) {
                                                            let selects: bo.SalesQuote[] = that.table.getSelecteds();
