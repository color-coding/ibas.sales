...
namespace sales {
    export namespace ui {
        export namespace c {
            /** 查看视图-规格模板 */
            export class SpecificationViewView extends ibas.BOViewView implements app.ISpecificationViewView {
                ...
                draw(): any {
                    ...
                    let formSpecificationItem: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        editable: true,
                        content: [
                            new sap.ui.core.Title("", { text: ibas.i18n.prop("bo_specificationitem") }),
