    ...
    export namespace ui {
        export namespace m {
            ...
            export class SalesReserveInvoiceEditView extends ibas.BOEditView implements app.ISalesReserveInvoiceEditView {
                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        sectionChange(event: sap.ui.base.Event): void {
                            ...
                            if (section instanceof sap.uxap.ObjectPageSection) {
                                if (section.getTitle() === ibas.i18n.prop("bo_salesreserveinvoiceitem")) {
                        ...
                        headerContent: [
                            new sap.extension.m.ObjectApprovalStatus("", {
                                title: ibas.i18n.prop("bo_salesreserveinvoice_approvalstatus"),
                                enumValue: {
                                    path: "approvalStatus",
                            ...
                            new sap.extension.m.ObjectDocumentCanceledStatus("", {
                                title: ibas.i18n.prop("bo_salesreserveinvoice_documentstatus"),
                                canceledStatus: {
                                    path: "canceled",
                            ...
                            new sap.extension.m.ObjectAttribute("", {
                                title: ibas.i18n.prop("bo_salesreserveinvoice_documentdate"),
                                bindingValue: {
                                    path: "documentDate",
                            ...
                            new sap.extension.m.ObjectAttribute("", {
                                title: ibas.i18n.prop("bo_salesreserveinvoice_documenttotal"),
                                bindingValue: {
                                    parts: [
                                        {
                                            path: "documentTotal",
                        ...
                        sections: [
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.ui.layout.form.SimpleForm("", {
                                                ...
                                                width: "auto",
                                                content: [
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoice_docnum") }),
                                                    new sap.extension.m.Input("", {
                                                    }).bindProperty("bindingValue", {
                                                        path: "docNum",
                                                        type: new sap.extension.data.Alphanumeric({
                                                    ...
                                                    new sap.extension.m.SeriesSelect("", {
                                                        objectCode: bo.BO_CODE_SALESRESERVEINVOICE,
                                                    }).bindProperty("bindingValue", {
                                                        path: "series",
                                                        type: new sap.extension.data.Numeric()
                                                    }).bindProperty("editable", {
                                                    ...
                                                    new sap.m.FlexBox("", {
                                                        ...
                                                        items: [
                                                            ...
                                                            new sap.extension.m.CheckBox("", {
                                                                text: ibas.i18n.prop("bo_salesreserveinvoice_printed"),
                                                                editable: false,
                                                            }).bindProperty("bindingValue", {
                                                                path: "printed",
                                                                type: new sap.extension.data.YesNo()
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                title: ibas.i18n.prop("bo_salesreserveinvoiceitem"),
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            this.listSalesReserveInvoiceItem = new sap.extension.m.List("", {
                                                inset: false,
                                                growing: false,
                                                width: "auto",
                                                            ...
                                                            items: [
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.addSalesReserveInvoiceItemEvent, that.listSalesReserveInvoiceItem.getSelecteds());
                                                                    }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem",
                                                                    icon: "sap-icon://delete",
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.removeSalesReserveInvoiceItemEvent, that.listSalesReserveInvoiceItem.getSelecteds());
                                                                    }
                                                                }),
                                                            ]
                                                        }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        attributes: [
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreserveinvoiceitem_quantity"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "quantity",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreserveinvoiceitem_price"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "price",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreserveinvoiceitem_linetotal"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "lineTotal",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreserveinvoiceitem_reference1"),
                                                                bindingValue: {
                                                                    path: "reference1",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreserveinvoiceitem_reference2"),
                                                                bindingValue: {
                                                                    path: "reference2",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.editSalesReserveInvoiceItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                },
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                private listSalesReserveInvoiceItem: sap.extension.m.List;
                ...
                showSalesReserveInvoiceItems(datas: bo.SalesReserveInvoiceItem[]): void {
                    this.listSalesReserveInvoiceItem.setModel(new sap.extension.model.JSONModel({ rows: datas }));
                }
                /** 编辑数据（销售预留发票-行） */
                editSalesReserveInvoiceItem(data: bo.SalesReserveInvoiceItem): void {
                    let that: this = this;
                    ...
                    if (!(editForm instanceof sap.m.Dialog)) {
                        editForm = new sap.m.Dialog(this.id + "_editform", {
                            title: ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_salesreserveinvoiceitem"), data.lineId),
                            ...
                            content: [
                                new sap.extension.layout.DataSimpleForm("", {
                                    ...
                                    content: [
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_lineid") }),
                                        new sap.extension.m.Input("", {
                                            editable: false,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_linestatus") }),
                                        new sap.extension.m.EnumSelect("", {
                                            enumType: ibas.emDocumentStatus
                                        }).bindProperty("bindingValue", {
                                            path: "lineStatus",
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_itemcode") }),
                                        new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    ...
                                                    if (data) {
                                                        that.fireViewEvents(that.chooseSalesReserveInvoiceItemMaterialEvent, data);
                                                    }
                                                }
                                            },
                                            showValueLink: true,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_itemdescription") }),
                                        new sap.extension.m.Input("", {
                                            editable: false,
                                        }).bindProperty("bindingValue", {
                                        ...
                                        new sap.m.Label("", {
                                            text: ibas.i18n.prop("bo_salesreserveinvoiceitem_itemversion"),
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_warehouse") }),
                                        new sap.extension.m.RepositoryInput("", {
                                            showValueHelp: true,
                                            repository: materials.bo.BORepositoryMaterials,
                                            dataInfo: {
                                            ...
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    let data: any = model.getData();
                                                    if (data) {
                                                        that.fireViewEvents(that.chooseSalesReserveInvoiceItemWarehouseEvent, data);
                                                    }
                                                }
                                            }
                                        }).bindProperty("bindingValue", {
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_quantity") }),
                                        new sap.m.FlexBox("", {
                                            width: "100%",
                                            justifyContent: sap.m.FlexJustifyContent.Start,
                                            renderType: sap.m.FlexRendertype.Bare,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_price") }),
                                        new sap.extension.m.Input("", {
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_linetotal") }),
                                        new sap.extension.m.Input("", {
                                            editable: true,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_tax") }),
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_reference1") }),
                                        new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "reference1",
                                            type: new sap.extension.data.Alphanumeric({
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreserveinvoiceitem_reference2") }),
                                        new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "reference2",
                                            type: new sap.extension.data.Alphanumeric({
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listSalesReserveInvoiceItem.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                ...
                                                editForm.setTitle(ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_salesreserveinvoiceitem"), datas[index].lineId));
                                            } else {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listSalesReserveInvoiceItem.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                that.fireViewEvents(that.removeSalesReserveInvoiceItemEvent, form.getModel().getData());
                                                if (datas.length === 1) {
                                                    // 无数据，退出
