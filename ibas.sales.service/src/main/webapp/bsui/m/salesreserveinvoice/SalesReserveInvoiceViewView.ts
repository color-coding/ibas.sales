...
namespace sales {
    export namespace ui {
        export namespace m {
            /** 查看视图-销售发票 */
            export class SalesReserveInvoiceViewView extends ibas.BOViewView implements app.ISalesReserveInvoiceViewView {
                /** 绘制视图 */
                draw(): any {
                    let that: this = this;
                                                        ...
                                                        parts: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                formatter(data: ibas.emYesNo): string {
                                                                    return ibas.emYesNo.YES === data ? ibas.i18n.prop("bo_salesreserveinvoice_canceled") : "";
                                                                },
                                                            },
                                                        ]
                                                    }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.viewSalesReserveInvoiceItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                }
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                /** 编辑数据行（销售发票-行） */
                viewSalesReserveInvoiceItem(data: bo.SalesReserveInvoiceItem): void {
                    let that: this = this;
