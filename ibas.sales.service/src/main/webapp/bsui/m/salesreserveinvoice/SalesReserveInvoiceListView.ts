                                    ...
                                    items: [
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press: function (event: sap.ui.base.Event): void {
                                                ...
                                                for (let item of that.list.getSelecteds<bo.SalesReserveInvoice>()) {
                                                    criteria.result++;
                        ...
                        items: {
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                ...
                                attributes: [
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesreserveinvoice_customercode"),
                                        bindingValue: {
                                            path: "customerCode",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesreserveinvoice_customername"),
                                        bindingValue: {
                                            path: "customerName",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesreserveinvoice_consumer"),
                                        bindingValue: {
                                            path: "consumer",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
