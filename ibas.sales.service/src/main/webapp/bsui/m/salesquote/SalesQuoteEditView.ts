                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        sectionChange(event: sap.ui.base.Event): void {
                            ...
                            if (section instanceof sap.uxap.ObjectPageSection) {
                                if (section.getTitle() === ibas.i18n.prop("bo_salesquoteitem")) {
                                                    ...
                                                    new sap.m.FlexBox("", {
                                                        ...
                                                        items: [
                                                            ...
                                                            new sap.extension.m.CheckBox("", {
                                                                text: ibas.i18n.prop("bo_salesquote_printed"),
                                                                editable: false,
                                                            }).bindProperty("bindingValue", {
                                                                path: "printed",
                                                                type: new sap.extension.data.YesNo()
                                                        ...
                                                        new sap.m.SegmentedButton("", {
                                                            items: [
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    press(oEvent: any): void { that.fireViewEvents(that.chooseSalesQuoteItemMaterialBatchEvent); }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem", icon: "sap-icon://barcode",
                                                                    press(oEvent: any): void { that.fireViewEvents(that.chooseSalesQuoteItemMaterialSerialEvent); }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem",
                                                                ...
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    icon: "sap-icon://copy",
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.addSalesQuoteItemEvent, that.listSalesQuoteItem.getSelecteds());
                                                                    }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem",
                            ...
                            content: [
                                new sap.extension.layout.DataSimpleForm("", {
                                    ...
                                    content: [
                                        ...
                                        new sap.extension.m.Input("", {
                                            ...
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    ...
                                                    if (data) {
                                                        that.fireViewEvents(that.chooseSalesQuoteItemMaterialEvent, data);
                                                    }
                                                }
                                            },
                                            showValueLink: true,
                                        ...
                                        new sap.m.Label("", {
                                            text: ibas.i18n.prop("bo_salesquoteitem_itemversion"),
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listSalesQuoteItem.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                that.fireViewEvents(that.removeSalesQuoteItemEvent, form.getModel().getData());
                                                if (datas.length === 1) {
                                                    // 无数据，退出
