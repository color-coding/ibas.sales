...
export class SalesReturnEditView extends ibas.BOEditView implements ISalesReturnEditView {
    ...
    darw(): any {
        ...
        this.viewTopForm = new sap.ui.layout.form.SimpleForm("", {
            ...
            content: [
                ...
                new sap.m.Input("", {
                    placeholder: ibas.i18n.prop("bo_salesreturn_customercode"),
                    tooltip: ibas.i18n.prop("bo_salesreturn_customercode"),
                    showValueHelp: true,
        ...
        // 子对象列表
        this.tableSalesReturnItem = new sap.m.List("", {
            inset: false,
            growing: true,
            ...
            headerToolbar: new sap.m.Toolbar("", {
                content: [
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            // 重写添加行事件。以适应移动端操作
                            that.addSalesReturnItemEvent = function (): void {
                                that.childEditForm.setModel(new sap.ui.model.json.JSONModel(this.editData.SalesReturnItems.create()));
                            ...
                            that.tableSalesReturnItem.swipeOut(null);
                ...
                content: [
                    ...
                    new sap.m.Button("", {
                        ...
                        press(oEvent: any): void {
                            ...
                            var editBo: bo.SalesReturnItem = parentControl.getSwipedItem().getBindingContext().getObject();
                    ...
                    new sap.m.Button("", {
                        ...
                        press(oEvent: any): void {
                            let parentControl: any = oEvent.getSource().getParent().getParent();
                            var deleteBo: bo.SalesReturnItem = parentControl.getSwipedItem().getBindingContext().getObject();
        ...
        that.tableSalesReturnItem.bindItems({
            path: "/rows",
            ...
            footer: new sap.m.Toolbar("", {
                content: [
                    ...
                    new sap.m.Button("", {
                        ...
                        icon: "sap-icon://delete",
                        press: function (): void {
                            let deleteBo: bo.SalesReturnItem = that.childEditForm.getBindingContext().getObject();
                            that.fireViewEvents(that.removeSalesReturnItemEvent,
                                deleteBo
                            );
    ...
    showSalesReturnItems(datas: bo.SalesReturnItem[]): void {
        ...
        // 监听属性改变，并更新控件
        utils.refreshModelChanged(this.tableSalesReturnItem, datas);
    }
