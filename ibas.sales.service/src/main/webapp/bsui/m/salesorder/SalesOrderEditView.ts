                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        headerContent: [
                            new sap.extension.m.ObjectApprovalStatus("", {
                                title: ibas.i18n.prop("bo_salesorder_approvalstatus"),
                                enumValue: {
                                    path: "approvalStatus",
                        ...
                        sections: [
                                                    ...
                                                    new sap.m.FlexBox("", {
                                                        ...
                                                        items: [
                                                            ...
                                                            new sap.extension.m.CheckBox("", {
                                                                text: ibas.i18n.prop("bo_salesorder_printed"),
                                                                editable: false,
                                                            }).bindProperty("bindingValue", {
                                                                path: "printed",
                                                                type: new sap.extension.data.YesNo()
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                ...
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            this.listSalesOrderItem = new sap.extension.m.List("", {
                                                inset: false,
                                                growing: false,
                                                width: "auto",
                                                        ...
                                                        new sap.m.SegmentedButton("", {
                                                            items: [
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.showSalesOrderItemExtraEvent,
                                                                            that.listSalesOrderItem.getSelecteds().firstOrDefault());
                                                                    },
                                                                    visible: shell.app.privileges.canRun({
                                                                ...
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    icon: "sap-icon://copy",
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.addSalesOrderItemEvent, that.listSalesOrderItem.getSelecteds());
                                                                    }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem",
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        attributes: [
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesorderitem_price"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "price",
                            ...
                            content: [
                                new sap.extension.layout.DataSimpleForm("", {
                                    ...
                                    content: [
                                        ...
                                        new sap.extension.m.Input("", {
                                            ...
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    ...
                                                    if (data) {
                                                        that.fireViewEvents(that.chooseSalesOrderItemMaterialEvent, data);
                                                    }
                                                }
                                            },
                                            showValueLink: true,
                                        ...
                                        new sap.m.Label("", {
                                            text: ibas.i18n.prop("bo_salesorderitem_itemversion"),
                                        ...
                                        new sap.extension.m.RepositoryInput("", {
                                            ...
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    let data: any = model.getData();
                                                    if (data) {
                                                        that.fireViewEvents(that.chooseSalesOrderItemWarehouseEvent, data);
                                                    }
                                                }
                                            }
                                        }).bindProperty("bindingValue", {
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesorderitem_tax") }),
