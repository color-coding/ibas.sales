                    ...
                    this.list = new sap.extension.m.List("", {
                                    ...
                                    items: [
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press(oEvent: any): void {
                                                that.fireViewEvents(that.removeSalesOrderItemExtraEvent, that.list.getSelecteds());
                                            }
                                        }),
                                    ]
                                }),
                        ...
                        items: {
                            ...
                            template: new sap.m.ObjectListItem("", {
                                ...
                                firstStatus: new sap.extension.m.ObjectApprovalStatus("", {
                                    text: {
                                        path: "quantity",
                                ...
                                attributes: [
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesorderitemextra_extrakey"),
                                        bindingValue: {
                                            path: "extraKey",
                                            formatter(data: any): any {
