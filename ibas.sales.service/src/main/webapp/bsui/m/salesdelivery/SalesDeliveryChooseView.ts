...
import { ISalesDeliveryChooseView } from "../../../bsapp/salesdelivery/index";
export class SalesDeliveryChooseView extends ibas.BOChooseView implements ISalesDeliveryChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
