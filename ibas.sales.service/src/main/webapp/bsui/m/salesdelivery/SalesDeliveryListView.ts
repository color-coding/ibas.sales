...
namespace sales {
    export namespace ui {
        export namespace m {
            /** 列表视图-销售交货 */
            export class SalesDeliveryListView extends ibas.BOListView implements app.ISalesDeliveryListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                                    ...
                                    items: [
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press: function (event: sap.ui.base.Event): void {
                                                ...
                                                for (let item of that.list.getSelecteds<bo.SalesDelivery>()) {
                                                    criteria.result++;
                        ...
                        items: {
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                ...
                                attributes: [
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesdelivery_customercode"),
                                        bindingValue: {
                                            path: "customerCode",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesdelivery_customername"),
                                        bindingValue: {
                                            path: "customerName",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
