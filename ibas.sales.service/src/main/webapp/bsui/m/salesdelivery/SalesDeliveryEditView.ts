    ...
    export namespace ui {
        export namespace m {
            ...
            export class SalesDeliveryEditView extends ibas.BOEditView implements app.ISalesDeliveryEditView {
                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        sectionChange(event: sap.ui.base.Event): void {
                            ...
                            if (section instanceof sap.uxap.ObjectPageSection) {
                                if (section.getTitle() === ibas.i18n.prop("bo_salesdeliveryitem")) {
                        ...
                        headerContent: [
                            new sap.extension.m.ObjectApprovalStatus("", {
                                title: ibas.i18n.prop("bo_salesdelivery_approvalstatus"),
                                enumValue: {
                                    path: "approvalStatus",
                                            ...
                                            new sap.ui.layout.form.SimpleForm("", {
                                                ...
                                                content: [
                                                    ...
                                                    new sap.extension.m.SeriesSelect("", {
                                                        objectCode: bo.BO_CODE_SALESDELIVERY,
                                                    }).bindProperty("bindingValue", {
                                                        path: "series",
                                                        type: new sap.extension.data.Numeric()
                                                    }).bindProperty("editable", {
                                                    ...
                                                    new sap.m.FlexBox("", {
                                                        ...
                                                        items: [
                                                            ...
                                                            new sap.extension.m.CheckBox("", {
                                                                text: ibas.i18n.prop("bo_salesdelivery_printed"),
                                                                editable: false,
                                                            }).bindProperty("bindingValue", {
                                                                path: "printed",
                                                                type: new sap.extension.data.YesNo()
                                                            ...
                                                            items: [
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.addSalesDeliveryItemEvent, that.listSalesDeliveryItem.getSelecteds());
                                                                    }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem",
                                                                    icon: "sap-icon://delete",
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.removeSalesDeliveryItemEvent, that.listSalesDeliveryItem.getSelecteds());
                                                                    }
                                                                }),
                                                            ]
                                                        }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        attributes: [
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesdeliveryitem_reference1"),
                                                                bindingValue: {
                                                                    path: "reference1",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesdeliveryitem_reference2"),
                                                                bindingValue: {
                                                                    path: "reference2",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.editSalesDeliveryItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                },
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                /** 编辑数据（销售交货-行） */
                editSalesDeliveryItem(data: bo.SalesDeliveryItem): void {
                    let that: this = this;
                    ...
                    if (!(editForm instanceof sap.m.Dialog)) {
                        editForm = new sap.m.Dialog(this.id + "_editform", {
                            title: ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_salesdeliveryitem"), data.lineId),
                            ...
                            content: [
                                new sap.extension.layout.DataSimpleForm("", {
                                    ...
                                    content: [
                                        ...
                                        new sap.m.Label("", {
                                            text: ibas.i18n.prop("bo_salesdeliveryitem_itemversion"),
                                        ...
                                        new sap.extension.m.RepositoryInput("", {
                                            ...
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    let data: any = model.getData();
                                                    if (data) {
                                                        that.fireViewEvents(that.chooseSalesDeliveryItemWarehouseEvent, data);
                                                    }
                                                }
                                            }
                                        }).bindProperty("bindingValue", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            ...
                                            if (datas instanceof Array && datas.length > 0) {
                                                ...
                                                editForm.setTitle(ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_salesdeliveryitem"), datas[index].lineId));
                                            } else {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listSalesDeliveryItem.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                that.fireViewEvents(that.removeSalesDeliveryItemEvent, form.getModel().getData());
                                                if (datas.length === 1) {
                                                    // 无数据，退出
