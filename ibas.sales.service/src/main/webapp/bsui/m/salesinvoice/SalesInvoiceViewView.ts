    ...
    export namespace ui {
        export namespace m {
            ...
            export class SalesInvoiceViewView extends ibas.BOViewView implements app.ISalesInvoiceViewView {
                                                        ...
                                                        parts: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                formatter(data: ibas.emYesNo): string {
                                                                    return ibas.emYesNo.YES === data ? ibas.i18n.prop("bo_salesinvoice_canceled") : "";
                                                                },
                                                            },
                                                        ]
                                                    }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.viewSalesInvoiceItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                }
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                /** 编辑数据行（销售发票-行） */
                viewSalesInvoiceItem(data: bo.SalesInvoiceItem): void {
                    let that: this = this;
