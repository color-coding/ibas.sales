...
namespace sales {
    export namespace ui {
        export namespace m {
            /** 选择视图-销售退货请求 */
            export class SalesReturnRequestChooseView extends ibas.BOChooseView implements app.ISalesReturnRequestChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                        ...
                        items: {
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                ...
                                attributes: [
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesreturnrequest_customercode"),
                                        bindingValue: {
                                            path: "customerCode",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesreturnrequest_customername"),
                                        bindingValue: {
                                            path: "customerName",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_salesreturnrequest_consumer"),
                                        bindingValue: {
                                            path: "consumer",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
