    ...
    export namespace ui {
        export namespace m {
            ...
            export class SalesReturnRequestViewView extends ibas.BOViewView implements app.ISalesReturnRequestViewView {
                                                        ...
                                                        parts: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                formatter(data: ibas.emYesNo): string {
                                                                    return ibas.emYesNo.YES === data ? ibas.i18n.prop("bo_salesreturnrequest_canceled") : "";
                                                                },
                                                            },
                                                        ]
                                                    }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.viewSalesReturnRequestItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                }
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                /** 编辑数据行（销售退货请求-行） */
                viewSalesReturnRequestItem(data: bo.SalesReturnRequestItem): void {
                    let that: this = this;
