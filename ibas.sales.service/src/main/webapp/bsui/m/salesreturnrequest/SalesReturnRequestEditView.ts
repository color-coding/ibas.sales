    ...
    export namespace ui {
        export namespace m {
            ...
            export class SalesReturnRequestEditView extends ibas.BOEditView implements app.ISalesReturnRequestEditView {
                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        sectionChange(event: sap.ui.base.Event): void {
                            ...
                            if (section instanceof sap.uxap.ObjectPageSection) {
                                if (section.getTitle() === ibas.i18n.prop("bo_salesreturnrequestitem")) {
                        ...
                        headerContent: [
                            new sap.extension.m.ObjectApprovalStatus("", {
                                title: ibas.i18n.prop("bo_salesreturnrequest_approvalstatus"),
                                enumValue: {
                                    path: "approvalStatus",
                            ...
                            new sap.extension.m.ObjectAttribute("", {
                                title: ibas.i18n.prop("bo_salesreturnrequest_documenttotal"),
                                bindingValue: {
                                    parts: [
                                        {
                                            path: "documentTotal",
                        ...
                        sections: [
                                            ...
                                            new sap.ui.layout.form.SimpleForm("", {
                                                ...
                                                content: [
                                                    ...
                                                    new sap.extension.m.TipsCheckBox("", {
                                                        text: ibas.i18n.prop("bbo_salesreturnrequest_canceled"),
                                                    ...
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequest_consumer") }),
                                                    new sap.extension.m.Input("", {
                                                    }).bindProperty("bindingValue", {
                                                        path: "consumer",
                                                        type: new sap.extension.data.Alphanumeric({
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                ...
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            this.listSalesReturnRequestItem = new sap.extension.m.List("", {
                                                inset: false,
                                                growing: false,
                                                width: "auto",
                                                            ...
                                                            items: [
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.addSalesReturnRequestItemEvent, that.listSalesReturnRequestItem.getSelecteds());
                                                                    }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem",
                                                                    icon: "sap-icon://delete",
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.removeSalesReturnRequestItemEvent, that.listSalesReturnRequestItem.getSelecteds());
                                                                    }
                                                                }),
                                                            ]
                                                        }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        attributes: [
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreturnrequestitem_quantity"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "quantity",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreturnrequestitem_price"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "price",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreturnrequestitem_linetotal"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "lineTotal",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreturnrequestitem_reference1"),
                                                                bindingValue: {
                                                                    path: "reference1",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_salesreturnrequestitem_reference2"),
                                                                bindingValue: {
                                                                    path: "reference2",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.editSalesReturnRequestItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                },
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                private listSalesReturnRequestItem: sap.extension.m.List;
                ...
                showSalesReturnRequestItems(datas: bo.SalesReturnRequestItem[]): void {
                    this.listSalesReturnRequestItem.setModel(new sap.extension.model.JSONModel({ rows: datas }));
                }
                /** 编辑数据（销售退货请求-行） */
                editSalesReturnRequestItem(data: bo.SalesReturnRequestItem): void {
                    let that: this = this;
                    ...
                    if (!(editForm instanceof sap.m.Dialog)) {
                        editForm = new sap.m.Dialog(this.id + "_editform", {
                            title: ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_salesreturnrequestitem"), data.lineId),
                            ...
                            content: [
                                new sap.extension.layout.DataSimpleForm("", {
                                    ...
                                    content: [
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_lineid") }),
                                        new sap.extension.m.Input("", {
                                            editable: false,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_linestatus") }),
                                        new sap.extension.m.EnumSelect("", {
                                            enumType: ibas.emDocumentStatus
                                        }).bindProperty("bindingValue", {
                                            path: "lineStatus",
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_itemcode") }),
                                        new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    ...
                                                    if (data) {
                                                        that.fireViewEvents(that.chooseSalesReturnRequestItemMaterialEvent, data);
                                                    }
                                                }
                                            },
                                            showValueLink: true,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_itemdescription") }),
                                        new sap.extension.m.Input("", {
                                            editable: false,
                                        }).bindProperty("bindingValue", {
                                        ...
                                        new sap.m.Label("", {
                                            text: ibas.i18n.prop("bo_salesreturnrequestitem_itemversion"),
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_warehouse") }),
                                        new sap.extension.m.RepositoryInput("", {
                                            showValueHelp: true,
                                            repository: materials.bo.BORepositoryMaterials,
                                            dataInfo: {
                                            ...
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    let data: any = model.getData();
                                                    if (data) {
                                                        that.fireViewEvents(that.chooseSalesReturnRequestItemWarehouseEvent, data);
                                                    }
                                                }
                                            }
                                        }).bindProperty("bindingValue", {
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_quantity") }),
                                        new sap.m.FlexBox("", {
                                            width: "100%",
                                            justifyContent: sap.m.FlexJustifyContent.Start,
                                            renderType: sap.m.FlexRendertype.Bare,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_price") }),
                                        new sap.extension.m.Input("", {
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_linetotal") }),
                                        new sap.extension.m.Input("", {
                                            editable: true,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_tax") }),
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_reference1") }),
                                        new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "reference1",
                                            type: new sap.extension.data.Alphanumeric({
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_salesreturnrequestitem_reference2") }),
                                        new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "reference2",
                                            type: new sap.extension.data.Alphanumeric({
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listSalesReturnRequestItem.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                ...
                                                editForm.setTitle(ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_salesreturnrequestitem"), datas[index].lineId));
                                            } else {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listSalesReturnRequestItem.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                that.fireViewEvents(that.removeSalesReturnRequestItemEvent, form.getModel().getData());
                                                if (datas.length === 1) {
                                                    // 无数据，退出
