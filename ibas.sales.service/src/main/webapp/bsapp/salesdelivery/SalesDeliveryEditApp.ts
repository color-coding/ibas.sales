...
namespace sales {
    export namespace app {
        ...
        export class SalesDeliveryEditApp extends ibas.BOEditService<ISalesDeliveryEditView, bo.SalesDelivery> {
            ...
            /** 更改行价格 */
            private changeSalesDeliveryItemPrice(priceList: number | ibas.Criteria, items?: bo.SalesDeliveryItem[]): void {
            ...
            /** 选择销售交货行物料事件 */
            private chooseSalesDeliveryItemMaterial(caller: bo.SalesDeliveryItem, type?: string): void {
                let that: this = this;
