...
namespace sales {
    export namespace app {
        /** 列表应用-销售贷项 */
        export class SalesCreditNoteListApp extends ibas.BOListApplication<ISalesCreditNoteListView, bo.SalesCreditNote> {

            /** 应用标识 */
            static APPLICATION_ID: string = "83ae451a-6672-45d4-9293-9d854aedb795";
            /** 应用名称 */
            static APPLICATION_NAME: string = "sales_app_salescreditnote_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.SalesCreditNote.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = SalesCreditNoteListApp.APPLICATION_ID;
                this.name = SalesCreditNoteListApp.APPLICATION_NAME;
                this.boCode = SalesCreditNoteListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.SalesCreditNote): void {
                ...
                let app: SalesCreditNoteViewApp = new SalesCreditNoteViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.SalesCreditNote | bo.SalesCreditNote[]): void {
                let beDeleteds: ibas.IList<bo.SalesCreditNote> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-销售贷项 */
        export interface ISalesCreditNoteListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
