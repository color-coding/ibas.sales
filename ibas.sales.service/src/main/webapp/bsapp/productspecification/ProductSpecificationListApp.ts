...
namespace sales {
    export namespace app {
        /** 列表应用-产品规格 */
        export class ProductSpecificationListApp extends ibas.BOListApplication<IProductSpecificationListView, bo.ProductSpecification> {

            /** 应用标识 */
            static APPLICATION_ID: string = "12807a2b-e1ce-48c2-a220-d36169ecf0fb";
            /** 应用名称 */
            static APPLICATION_NAME: string = "sales_app_productspecification_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.ProductSpecification.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = ProductSpecificationListApp.APPLICATION_ID;
                this.name = ProductSpecificationListApp.APPLICATION_NAME;
                this.boCode = ProductSpecificationListApp.BUSINESS_OBJECT_CODE;
            ...
            protected deleteData(data: bo.ProductSpecification | bo.ProductSpecification[]): void {
                let beDeleteds: ibas.IList<bo.ProductSpecification> = ibas.arrays.create(data);
                // 没有选择删除的对象
