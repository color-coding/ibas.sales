...
namespace sales {
    export namespace app {
        ...
        export class SalesQuoteEditApp extends ibas.BOEditService<ISalesQuoteEditView, bo.SalesQuote> {
            ...
            /** 更改行价格 */
            private changeSalesQuoteItemPrice(priceList: number | ibas.Criteria, items?: bo.SalesQuoteItem[]): void {
            ...
            private chooseSalesQuoteItemUnit(caller: bo.SalesQuoteItem): void {
                let that: this = this;
