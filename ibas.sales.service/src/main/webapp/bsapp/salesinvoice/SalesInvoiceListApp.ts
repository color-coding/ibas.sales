...
namespace sales {
    export namespace app {
        /** 列表应用-销售发票 */
        export class SalesInvoiceListApp extends ibas.BOListApplication<ISalesInvoiceListView, bo.SalesInvoice> {

            /** 应用标识 */
            static APPLICATION_ID: string = "34268a21-a28d-40c4-9884-f32596c23500";
            /** 应用名称 */
            static APPLICATION_NAME: string = "sales_app_salesinvoice_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.SalesInvoice.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = SalesInvoiceListApp.APPLICATION_ID;
                this.name = SalesInvoiceListApp.APPLICATION_NAME;
                this.boCode = SalesInvoiceListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.SalesInvoice): void {
                ...
                let app: SalesInvoiceViewApp = new SalesInvoiceViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.SalesInvoice | bo.SalesInvoice[]): void {
                let beDeleteds: ibas.IList<bo.SalesInvoice> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-销售发票 */
        export interface ISalesInvoiceListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
