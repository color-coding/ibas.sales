...
namespace sales {
    export namespace app {
        /** 列表应用-规格模板 */
        export class SpecificationListApp extends ibas.BOListApplication<ISpecificationListView, bo.Specification> {

            /** 应用标识 */
            static APPLICATION_ID: string = "b933d496-144a-4925-9db7-1f6fd85810e4";
            /** 应用名称 */
            static APPLICATION_NAME: string = "sales_app_specification_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.Specification.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = SpecificationListApp.APPLICATION_ID;
                this.name = SpecificationListApp.APPLICATION_NAME;
                this.boCode = SpecificationListApp.BUSINESS_OBJECT_CODE;
            ...
            protected deleteData(data: bo.Specification | bo.Specification[]): void {
                let beDeleteds: ibas.IList<bo.Specification> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-规格模板 */
        export interface ISpecificationListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
