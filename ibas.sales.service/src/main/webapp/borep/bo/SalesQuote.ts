...
namespace sales {
    export namespace bo {
        /** 销售订单 */
        export class SalesQuote extends ibas.BODocument<SalesQuote> implements ISalesQuote {
        ...
        export class SalesQuoteItem extends ibas.BODocumentLine<SalesQuoteItem> implements ISalesQuoteItem {
            ...
            /** 获取-项目代码 */
            get project(): string {
                return this.getProperty<string>(SalesQuoteItem.PROPERTY_PROJECT_NAME);
            }
            /** 设置-项目代码 */
            set project(value: string) {
                this.setProperty(SalesQuoteItem.PROPERTY_PROJECT_NAME, value);
            }
