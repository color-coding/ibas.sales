...
namespace sales {
    export namespace bo {
        ...
        export class SalesReturn extends ibas.BODocument<SalesReturn> implements ISalesReturn, ibas.IConvertedData {
            ...
            /** 获取-单据编码 */
            get docNum(): string {
                return this.getProperty<string>(SalesReturn.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-单据编码 */
            ...
            get printed(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(SalesReturn.PROPERTY_PRINTED_NAME);
            }
            /** 设置-已打印 */
            set printed(value: ibas.emYesNo) {
                this.setProperty(SalesReturn.PROPERTY_PRINTED_NAME, value);
            }
            ...
            get shippingsTaxTotal(): number {
                return this.getProperty<number>(SalesReturn.PROPERTY_SHIPPINGSTAXTOTAL_NAME);
            }
            /** 设置-运送费税总计 */
            set shippingsTaxTotal(value: number) {
                this.setProperty(SalesReturn.PROPERTY_SHIPPINGSTAXTOTAL_NAME, value);
            }

            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    // 计算-舍入差异
                    new BusinessRuleRoundingAmount(SalesReturn.PROPERTY_ROUNDING_NAME, SalesReturn.PROPERTY_DIFFAMOUNT_NAME),
                    // 计算行-总计（含税）
                    ...
                    // 计算运输-税总计
                    new ibas.BusinessRuleSumElements(
                        SalesReturn.PROPERTY_SHIPPINGSTAXTOTAL_NAME, SalesReturn.PROPERTY_SHIPPINGADDRESSS_NAME, ShippingAddress.PROPERTY_TAXTOTAL_NAME),
                    // 折扣后总计（含税） = 行-总计（含税）* 折扣
                    ...
                    new BusinessRuleDeductionDocumentTotal(SalesReturn.PROPERTY_DOCUMENTTOTAL_NAME,
                        SalesReturn.PROPERTY_DISCOUNTTOTAL_NAME, SalesReturn.PROPERTY_SHIPPINGSEXPENSETOTAL_NAME, SalesReturn.PROPERTY_DIFFAMOUNT_NAME
                    ),
                    // 计算正反折扣
                    new BusinessRuleNegativeDiscount(
                        SalesReturn.PROPERTY_DISCOUNT_NAME, SalesReturn.PROPERTY_INVERSEDISCOUNT_NAME
                    ),
                ];
            }
            /** 重置 */
            reset(): void {
                ...
                this.paidTotal = 0;
                this.documentStatus = ibas.emDocumentStatus.RELEASED;
                this.salesReturnItems.forEach(c => c.lineStatus = ibas.emDocumentStatus.RELEASED);
            }
            /** 转换之前 */
            beforeConvert(): void { }
            /** 数据解析后 */
        ...
        export class SalesReturnItems extends ibas.BusinessObjects<SalesReturnItem, SalesReturn> implements ISalesReturnItems {
            ...
            protected onItemPropertyChanged(item: SalesReturnItem, name: string): void {
                ...
                // 标记删除触发集合行变化
                if (ibas.strings.equalsIgnoreCase(name, SalesReturnItem.PROPERTY_DELETED_NAME)
                    || ibas.strings.equalsIgnoreCase(name, SalesReturnItem.PROPERTY_CANCELED_NAME)) {
        ...
        export class SalesReturnItem extends ibas.BODocumentLine<SalesReturnItem> implements ISalesReturnItem {
            ...
            get catalogCode(): string {
                return this.getProperty<string>(SalesReturnItem.PROPERTY_CATALOGCODE_NAME);
            }
            /** 设置-目录编码 */
            set catalogCode(value: string) {
                this.setProperty(SalesReturnItem.PROPERTY_CATALOGCODE_NAME, value);
            }
            ...
            get itemVersion(): string {
                return this.getProperty<string>(SalesReturnItem.PROPERTY_ITEMVERSION_NAME);
            }
            /** 设置-产品版本 */
            set itemVersion(value: string) {
                this.setProperty(SalesReturnItem.PROPERTY_ITEMVERSION_NAME, value);
            }
            ...
            get inventoryUOM(): string {
                return this.getProperty<string>(SalesReturnItem.PROPERTY_INVENTORYUOM_NAME);
            }
            /** 设置-库存单位 */
            set inventoryUOM(value: string) {
                this.setProperty(SalesReturnItem.PROPERTY_INVENTORYUOM_NAME, value);
            }
            ...
            /** 获取-单位换算率 */
            get uomRate(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_UOMRATE_NAME);
            }
            /** 设置-单位换算率 */
            set uomRate(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_UOMRATE_NAME, value);
            }
            ...
            get inventoryQuantity(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_INVENTORYQUANTITY_NAME);
            }
            /** 设置-库存数量 */
            set inventoryQuantity(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_INVENTORYQUANTITY_NAME, value);
            }
            ...
            get unitLineTotal(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_UNITLINETOTAL_NAME);
            }
            /** 设置-折扣前行总计 */
            set unitLineTotal(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_UNITLINETOTAL_NAME, value);
            }
            ...
            get preTaxPrice(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_PRETAXPRICE_NAME);
            }
            /** 设置-税前价格 */
            set preTaxPrice(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_PRETAXPRICE_NAME, value);
            }
            ...
            get preTaxLineTotal(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_PRETAXLINETOTAL_NAME);
            }
            /** 设置-税前行总计 */
            set preTaxLineTotal(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_PRETAXLINETOTAL_NAME, value);
            }
            ...
            /** 获取-合同 */
            get agreements(): string {
                return this.getProperty<string>(SalesReturnItem.PROPERTY_AGREEMENTS_NAME);
            }
            /** 设置-合同 */
            set agreements(value: string) {
                this.setProperty(SalesReturnItem.PROPERTY_AGREEMENTS_NAME, value);
            }
            ...
            get returnCost(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_RETURNCOST_NAME);
            }
            /** 设置-退货成本（本币） */
            set returnCost(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_RETURNCOST_NAME, value);
            }
            ...
            /** 获取-毛利基础 */
            get grossBase(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_GROSSBASE_NAME);
            }
            /** 设置-毛利基础 */
            set grossBase(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_GROSSBASE_NAME, value);
            }
            ...
            /** 获取-反向行折扣 */
            get inverseDiscount(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_INVERSEDISCOUNT_NAME);
            }
            /** 设置-反向行折扣 */
            set inverseDiscount(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_INVERSEDISCOUNT_NAME, value);
            }
            /** 映射的属性名称-价格（本币） */
            static PROPERTY_PRICELC_NAME: string = "PriceLC";
            /** 获取-价格（本币） */
            get priceLC(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_PRICELC_NAME);
            }
            /** 设置-价格（本币） */
            set priceLC(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_PRICELC_NAME, value);
            }
            ...
            get unitPriceLC(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_UNITPRICELC_NAME);
            }
            /** 设置-折扣前价格（本币） */
            set unitPriceLC(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_UNITPRICELC_NAME, value);
            }
            ...
            get preTaxPriceLC(): number {
                return this.getProperty<number>(SalesReturnItem.PROPERTY_PRETAXPRICELC_NAME);
            }
            /** 设置-税前价格（本币） */
            set preTaxPriceLC(value: number) {
                this.setProperty(SalesReturnItem.PROPERTY_PRETAXPRICELC_NAME, value);
            }
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesReturnItem.PROPERTY_UNITPRICELC_NAME, SalesReturnItem.PROPERTY_UNITPRICE_NAME, SalesReturnItem.PROPERTY_RATE_NAME
                    ),
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesReturnItem.PROPERTY_PRETAXPRICELC_NAME, SalesReturnItem.PROPERTY_PRETAXPRICE_NAME, SalesReturnItem.PROPERTY_RATE_NAME
                    ),
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesReturnItem.PROPERTY_PRICELC_NAME, SalesReturnItem.PROPERTY_PRICE_NAME, SalesReturnItem.PROPERTY_RATE_NAME
                    ),
                    // 计算库存数量 = 数量 * 换算率
                    new BusinessRuleCalculateInventoryQuantity(
                        SalesReturnItem.PROPERTY_INVENTORYQUANTITY_NAME, SalesReturnItem.PROPERTY_QUANTITY_NAME, SalesReturnItem.PROPERTY_UOMRATE_NAME),
                    // 计算折扣前总计 = 数量 * 折扣前价格
                    new BusinessRuleDeductionPriceQtyTotal(
                        SalesReturnItem.PROPERTY_UNITLINETOTAL_NAME, SalesReturnItem.PROPERTY_UNITPRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesReturnItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesReturnItem.PROPERTY_QUANTITY_NAME
                    ),
                    // 计算 行总计 = 税前总计（折扣后） + 税总计；行总计 = 价格（税后） * 数量；税总计 = 税前总计（折扣后） * 税率
                    new BusinessRuleDeductionPriceTaxTotal(SalesReturnItem.PROPERTY_LINETOTAL_NAME, SalesReturnItem.PROPERTY_PRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesReturnItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesReturnItem.PROPERTY_QUANTITY_NAME,
                        SalesReturnItem.PROPERTY_TAXRATE_NAME, SalesReturnItem.PROPERTY_TAXTOTAL_NAME, SalesReturnItem.PROPERTY_PRETAXLINETOTAL_NAME
                    ),
                    // 计算折扣后总计（税前） = 数量 * 折扣后价格（税前）
                    new BusinessRuleDeductionPriceQtyTotal(
                        SalesReturnItem.PROPERTY_PRETAXLINETOTAL_NAME, SalesReturnItem.PROPERTY_PRETAXPRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesReturnItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesReturnItem.PROPERTY_QUANTITY_NAME
                    ),
                    // 计算折扣后总计 = 折扣前总计 * 折扣
                    new BusinessRuleDeductionDiscount(
                        SalesReturnItem.PROPERTY_DISCOUNT_NAME, SalesReturnItem.PROPERTY_UNITLINETOTAL_NAME, SalesReturnItem.PROPERTY_PRETAXLINETOTAL_NAME
                    ),
                    // 计算正反折扣
                    new BusinessRuleNegativeDiscount(
                        SalesReturnItem.PROPERTY_DISCOUNT_NAME, SalesReturnItem.PROPERTY_INVERSEDISCOUNT_NAME
                    ),
                ];
            }
            /** 重置 */
