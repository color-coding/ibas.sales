...
/** 产品套装 */
export class ProductSuit extends BOSimple<ProductSuit> implements IProductSuit {
    ...
    get activated(): emYesNo {
        return this.getProperty<emYesNo>(ProductSuit.PROPERTY_ACTIVATED_NAME);
    }
    /** 设置-是否激活 */
    ...
    get approvalStatus(): emApprovalStatus {
        return this.getProperty<emApprovalStatus>(ProductSuit.PROPERTY_APPROVALSTATUS_NAME);
    }
    /** 设置-审批状态 */
...
/** 产品套装-项目 集合 */
export class ProductSuitItems extends BusinessObjects<ProductSuitItem, ProductSuit> implements IProductSuitItems {
...
/** 产品套装-项目 */
export class ProductSuitItem extends BOSimpleLine<ProductSuitItem> implements IProductSuitItem {
