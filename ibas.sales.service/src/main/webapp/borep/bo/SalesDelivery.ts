...
namespace sales {
    export namespace bo {
        /** 销售交货 */
        export class SalesDelivery extends ibas.BODocument<SalesDelivery> implements ISalesDelivery, ibas.IConvertedData {
            ...
            /** 获取-单据编码 */
            get docNum(): string {
                return this.getProperty<string>(SalesDelivery.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-单据编码 */
            ...
            get printed(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(SalesDelivery.PROPERTY_PRINTED_NAME);
            }
            /** 设置-已打印 */
            set printed(value: ibas.emYesNo) {
                this.setProperty(SalesDelivery.PROPERTY_PRINTED_NAME, value);
            }
            ...
            get grossBase(): number {
                return this.getProperty<number>(SalesDelivery.PROPERTY_GROSSBASE_NAME);
            }
            /** 设置-毛利价格清单 */
            set grossBase(value: number) {
                this.setProperty(SalesDelivery.PROPERTY_GROSSBASE_NAME, value);
            }
            ...
            get itemsPreTaxTotal(): number {
                return this.getProperty<number>(SalesDelivery.PROPERTY_ITEMSPRETAXTOTAL_NAME);
            }
            /** 设置-项目的税前行总计 */
            set itemsPreTaxTotal(value: number) {
                this.setProperty(SalesDelivery.PROPERTY_ITEMSPRETAXTOTAL_NAME, value);
            }
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    // 计算-舍入差异
                    new BusinessRuleRoundingAmount(SalesDelivery.PROPERTY_ROUNDING_NAME, SalesDelivery.PROPERTY_DIFFAMOUNT_NAME),
                    // 计算行-总计（含税）
                    new ibas.BusinessRuleSumElements(
                        ...
                        (data: SalesDeliveryItem): boolean => {
                            // 不计标记删除项
                    ...
                    // 计算行-税前总计
                    new ibas.BusinessRuleSumElements(
                        SalesDelivery.PROPERTY_ITEMSPRETAXTOTAL_NAME, SalesDelivery.PROPERTY_SALESDELIVERYITEMS_NAME, SalesDeliveryItem.PROPERTY_PRETAXLINETOTAL_NAME,
                        (data: SalesDeliveryItem): boolean => {
                            // 不计标记删除项
                            if (config.isStatisticsTagDeleted() === false && data.deleted === ibas.emYesNo.YES) {
                                return false;
                    ...
                    new BusinessRuleDeductionDocumentTotal(SalesDelivery.PROPERTY_DOCUMENTTOTAL_NAME,
                        SalesDelivery.PROPERTY_DISCOUNTTOTAL_NAME, SalesDelivery.PROPERTY_SHIPPINGSEXPENSETOTAL_NAME, SalesDelivery.PROPERTY_DIFFAMOUNT_NAME
                    ),
                    // 计算正反折扣
            ...
            reset(): void {
                ...
                this.paidTotal = 0;
                this.documentStatus = ibas.emDocumentStatus.RELEASED;
                this.salesDeliveryItems.forEach(c => c.lineStatus = ibas.emDocumentStatus.RELEASED);
            }
            /** 转换之前 */
            beforeConvert(): void { }
            /** 数据解析后 */
            ...
            baseDocument(): void {
                if (ibas.objects.instanceOf(arguments[0], SalesOrder)) {
                    let document: ISalesOrder = arguments[0];
                ...
                if (ibas.objects.instanceOf(arguments[0], SalesReserveInvoice)) {
                    let document: ISalesReserveInvoice = arguments[0];
                    if (!ibas.strings.equals(this.customerCode, document.customerCode)) {
                        return;
                    }
                    // 复制头信息
        ...
        export class SalesDeliveryItems extends ibas.BusinessObjects<SalesDeliveryItem, SalesDelivery> implements ISalesDeliveryItems {
            ...
            protected onItemPropertyChanged(item: SalesDeliveryItem, name: string): void {
                ...
                // 标记删除触发集合行变化
                if (ibas.strings.equalsIgnoreCase(name, SalesDeliveryItem.PROPERTY_DELETED_NAME)
                    || ibas.strings.equalsIgnoreCase(name, SalesDeliveryItem.PROPERTY_CANCELED_NAME)) {
        ...
        export class SalesDeliveryItem extends ibas.BODocumentLine<SalesDeliveryItem> implements ISalesDeliveryItem {
            ...
            /** 获取-产品标识 */
            get itemSign(): string {
                return this.getProperty<string>(SalesDeliveryItem.PROPERTY_ITEMSIGN_NAME);
            }
            /** 设置-产品标识 */
            set itemSign(value: string) {
                this.setProperty(SalesDeliveryItem.PROPERTY_ITEMSIGN_NAME, value);
            }
            ...
            get catalogCode(): string {
                return this.getProperty<string>(SalesDeliveryItem.PROPERTY_CATALOGCODE_NAME);
            }
            /** 设置-目录编码 */
            set catalogCode(value: string) {
                this.setProperty(SalesDeliveryItem.PROPERTY_CATALOGCODE_NAME, value);
            }
            ...
            get inventoryUOM(): string {
                return this.getProperty<string>(SalesDeliveryItem.PROPERTY_INVENTORYUOM_NAME);
            }
            /** 设置-库存单位 */
            set inventoryUOM(value: string) {
                this.setProperty(SalesDeliveryItem.PROPERTY_INVENTORYUOM_NAME, value);
            }
            ...
            /** 获取-单位换算率 */
            get uomRate(): number {
                return this.getProperty<number>(SalesDeliveryItem.PROPERTY_UOMRATE_NAME);
            }
            /** 设置-单位换算率 */
            set uomRate(value: number) {
                this.setProperty(SalesDeliveryItem.PROPERTY_UOMRATE_NAME, value);
            }
            ...
            get inventoryQuantity(): number {
                return this.getProperty<number>(SalesDeliveryItem.PROPERTY_INVENTORYQUANTITY_NAME);
            }
            /** 设置-库存数量 */
            set inventoryQuantity(value: number) {
                this.setProperty(SalesDeliveryItem.PROPERTY_INVENTORYQUANTITY_NAME, value);
            }
            ...
            get unitLineTotal(): number {
                return this.getProperty<number>(SalesDeliveryItem.PROPERTY_UNITLINETOTAL_NAME);
            }
            /** 设置-折扣前行总计 */
            set unitLineTotal(value: number) {
                this.setProperty(SalesDeliveryItem.PROPERTY_UNITLINETOTAL_NAME, value);
            }
            ...
            /** 获取-合同 */
            get agreements(): string {
                return this.getProperty<string>(SalesDeliveryItem.PROPERTY_AGREEMENTS_NAME);
            }
            /** 设置-合同 */
            set agreements(value: string) {
                this.setProperty(SalesDeliveryItem.PROPERTY_AGREEMENTS_NAME, value);
            }
            ...
            /** 获取-毛利基础 */
            get grossBase(): number {
                return this.getProperty<number>(SalesDeliveryItem.PROPERTY_GROSSBASE_NAME);
            }
            /** 设置-毛利基础 */
            set grossBase(value: number) {
                this.setProperty(SalesDeliveryItem.PROPERTY_GROSSBASE_NAME, value);
            }
            ...
            /** 获取-价格（本币） */
            get priceLC(): number {
                return this.getProperty<number>(SalesDeliveryItem.PROPERTY_PRICELC_NAME);
            }
            /** 设置-价格（本币） */
            set priceLC(value: number) {
                this.setProperty(SalesDeliveryItem.PROPERTY_PRICELC_NAME, value);
            }
            ...
            get unitPriceLC(): number {
                return this.getProperty<number>(SalesDeliveryItem.PROPERTY_UNITPRICELC_NAME);
            }
            /** 设置-折扣前价格（本币） */
            set unitPriceLC(value: number) {
                this.setProperty(SalesDeliveryItem.PROPERTY_UNITPRICELC_NAME, value);
            }
            ...
            get preTaxPriceLC(): number {
                return this.getProperty<number>(SalesDeliveryItem.PROPERTY_PRETAXPRICELC_NAME);
            }
            /** 设置-税前价格（本币） */
            set preTaxPriceLC(value: number) {
                this.setProperty(SalesDeliveryItem.PROPERTY_PRETAXPRICELC_NAME, value);
            }
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesDeliveryItem.PROPERTY_UNITPRICELC_NAME, SalesDeliveryItem.PROPERTY_UNITPRICE_NAME, SalesDeliveryItem.PROPERTY_RATE_NAME
                    ),
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesDeliveryItem.PROPERTY_PRETAXPRICELC_NAME, SalesDeliveryItem.PROPERTY_PRETAXPRICE_NAME, SalesDeliveryItem.PROPERTY_RATE_NAME
                    ),
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesDeliveryItem.PROPERTY_PRICELC_NAME, SalesDeliveryItem.PROPERTY_PRICE_NAME, SalesDeliveryItem.PROPERTY_RATE_NAME
                    ),
                    // 计算库存数量 = 数量 * 换算率
                    new BusinessRuleCalculateInventoryQuantity(
                        SalesDeliveryItem.PROPERTY_INVENTORYQUANTITY_NAME, SalesDeliveryItem.PROPERTY_QUANTITY_NAME, SalesDeliveryItem.PROPERTY_UOMRATE_NAME),
                    // 计算折扣前总计 = 数量 * 折扣前价格
                    new BusinessRuleDeductionPriceQtyTotal(
                        SalesDeliveryItem.PROPERTY_UNITLINETOTAL_NAME, SalesDeliveryItem.PROPERTY_UNITPRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesDeliveryItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesDeliveryItem.PROPERTY_QUANTITY_NAME
                    ),
                    // 计算 行总计 = 税前总计（折扣后） + 税总计；行总计 = 价格（税后） * 数量；税总计 = 税前总计（折扣后） * 税率
                    new BusinessRuleDeductionPriceTaxTotal(SalesDeliveryItem.PROPERTY_LINETOTAL_NAME, SalesDeliveryItem.PROPERTY_PRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesDeliveryItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesDeliveryItem.PROPERTY_QUANTITY_NAME,
                        SalesDeliveryItem.PROPERTY_TAXRATE_NAME, SalesDeliveryItem.PROPERTY_TAXTOTAL_NAME, SalesDeliveryItem.PROPERTY_PRETAXLINETOTAL_NAME
                    ),
                    // 计算折扣后总计（税前） = 数量 * 折扣后价格（税前）
                    new BusinessRuleDeductionPriceQtyTotal(
                        SalesDeliveryItem.PROPERTY_PRETAXLINETOTAL_NAME, SalesDeliveryItem.PROPERTY_PRETAXPRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesDeliveryItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesDeliveryItem.PROPERTY_QUANTITY_NAME
                    ),
                    // 计算折扣后总计 = 折扣前总计 * 折扣
