...
namespace sales {
    export namespace bo {
        ...
        export class SalesOrder extends ibas.BODocument<SalesOrder> implements ISalesOrder, ibas.IConvertedData {
            ...
            /** 获取-单据编码 */
            get docNum(): string {
                return this.getProperty<string>(SalesOrder.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-单据编码 */
            ...
            get printed(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(SalesOrder.PROPERTY_PRINTED_NAME);
            }
            /** 设置-已打印 */
            set printed(value: ibas.emYesNo) {
                this.setProperty(SalesOrder.PROPERTY_PRINTED_NAME, value);
            }
            ...
            get agreements(): string {
                return this.getProperty<string>(SalesOrder.PROPERTY_AGREEMENTS_NAME);
            }
            /** 设置-合同 */
            set agreements(value: string) {
                this.setProperty(SalesOrder.PROPERTY_AGREEMENTS_NAME, value);
            }
            ...
            /** 获取-分支 */
            get branch(): string {
                return this.getProperty<string>(SalesOrder.PROPERTY_BRANCH_NAME);
            }
            /** 设置-分支 */
            set branch(value: string) {
                this.setProperty(SalesOrder.PROPERTY_BRANCH_NAME, value);
            }
            ...
            get grossBase(): number {
                return this.getProperty<number>(SalesOrder.PROPERTY_GROSSBASE_NAME);
            }
            /** 设置-毛利价格清单 */
            set grossBase(value: number) {
                this.setProperty(SalesOrder.PROPERTY_GROSSBASE_NAME, value);
            }
            ...
            get itemsPreTaxTotal(): number {
                return this.getProperty<number>(SalesOrder.PROPERTY_ITEMSPRETAXTOTAL_NAME);
            }
            /** 设置-项目的税前行总计 */
            set itemsPreTaxTotal(value: number) {
                this.setProperty(SalesOrder.PROPERTY_ITEMSPRETAXTOTAL_NAME, value);
            }
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    // 计算-舍入差异
                    new BusinessRuleRoundingAmount(SalesOrder.PROPERTY_ROUNDING_NAME, SalesOrder.PROPERTY_DIFFAMOUNT_NAME),
                    // 计算行-总计（含税）
                    ...
                    new BusinessRuleDeductionDocumentTotal(SalesOrder.PROPERTY_DOCUMENTTOTAL_NAME,
                        SalesOrder.PROPERTY_DISCOUNTTOTAL_NAME, SalesOrder.PROPERTY_SHIPPINGSEXPENSETOTAL_NAME, SalesOrder.PROPERTY_DIFFAMOUNT_NAME
                    ),
                    // 计算正反折扣
        ...
        export class SalesOrderItem extends ibas.BODocumentLine<SalesOrderItem> implements ISalesOrderItem {
            ...
            get catalogCode(): string {
                return this.getProperty<string>(SalesOrderItem.PROPERTY_CATALOGCODE_NAME);
            }
            /** 设置-目录编码 */
            set catalogCode(value: string) {
                this.setProperty(SalesOrderItem.PROPERTY_CATALOGCODE_NAME, value);
            }
            ...
            get itemVersion(): string {
                return this.getProperty<string>(SalesOrderItem.PROPERTY_ITEMVERSION_NAME);
            }
            /** 设置-产品版本 */
            set itemVersion(value: string) {
                this.setProperty(SalesOrderItem.PROPERTY_ITEMVERSION_NAME, value);
            }
            ...
            /** 获取-合同 */
            get agreements(): string {
                return this.getProperty<string>(SalesOrderItem.PROPERTY_AGREEMENTS_NAME);
            }
            /** 设置-合同 */
            set agreements(value: string) {
                this.setProperty(SalesOrderItem.PROPERTY_AGREEMENTS_NAME, value);
            }
            ...
            /** 获取-毛利基础 */
            get grossBase(): number {
                return this.getProperty<number>(SalesOrderItem.PROPERTY_GROSSBASE_NAME);
            }
            /** 设置-毛利基础 */
            set grossBase(value: number) {
                this.setProperty(SalesOrderItem.PROPERTY_GROSSBASE_NAME, value);
            }
            ...
            /** 获取-价格（本币） */
            get priceLC(): number {
                return this.getProperty<number>(SalesOrderItem.PROPERTY_PRICELC_NAME);
            }
            /** 设置-价格（本币） */
            set priceLC(value: number) {
                this.setProperty(SalesOrderItem.PROPERTY_PRICELC_NAME, value);
            }
            ...
            get unitPriceLC(): number {
                return this.getProperty<number>(SalesOrderItem.PROPERTY_UNITPRICELC_NAME);
            }
            /** 设置-折扣前价格（本币） */
            set unitPriceLC(value: number) {
                this.setProperty(SalesOrderItem.PROPERTY_UNITPRICELC_NAME, value);
            }
            ...
            get preTaxPriceLC(): number {
                return this.getProperty<number>(SalesOrderItem.PROPERTY_PRETAXPRICELC_NAME);
            }
            /** 设置-税前价格（本币） */
            set preTaxPriceLC(value: number) {
                this.setProperty(SalesOrderItem.PROPERTY_PRETAXPRICELC_NAME, value);
            }
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesOrderItem.PROPERTY_UNITPRICELC_NAME, SalesOrderItem.PROPERTY_UNITPRICE_NAME, SalesOrderItem.PROPERTY_RATE_NAME
                    ),
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesOrderItem.PROPERTY_PRETAXPRICELC_NAME, SalesOrderItem.PROPERTY_PRETAXPRICE_NAME, SalesOrderItem.PROPERTY_RATE_NAME
                    ),
                    new BusinessRuleDeductionCurrencyAmount(
                        SalesOrderItem.PROPERTY_PRICELC_NAME, SalesOrderItem.PROPERTY_PRICE_NAME, SalesOrderItem.PROPERTY_RATE_NAME
                    ),
                    // 计算库存数量 = 数量 * 换算率
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        SalesOrderItem.PROPERTY_UNITLINETOTAL_NAME, SalesOrderItem.PROPERTY_UNITPRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesOrderItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesOrderItem.PROPERTY_QUANTITY_NAME
                    ),
                    // 计算 行总计 = 税前总计（折扣后） + 税总计；行总计 = 价格（税后） * 数量；税总计 = 税前总计（折扣后） * 税率
                    new BusinessRuleDeductionPriceTaxTotal(SalesOrderItem.PROPERTY_LINETOTAL_NAME, SalesOrderItem.PROPERTY_PRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesOrderItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesOrderItem.PROPERTY_QUANTITY_NAME,
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        SalesOrderItem.PROPERTY_PRETAXLINETOTAL_NAME, SalesOrderItem.PROPERTY_PRETAXPRICE_NAME,
                        config.isInventoryUnitLinePrice() ? SalesOrderItem.PROPERTY_INVENTORYQUANTITY_NAME : SalesOrderItem.PROPERTY_QUANTITY_NAME
                    ),
                    // 计算折扣后总计 = 折扣前总计 * 折扣
