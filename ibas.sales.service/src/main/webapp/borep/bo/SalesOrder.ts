    ...
    export namespace bo {
        ...
        export class SalesOrder extends ibas.BODocument<SalesOrder> implements ISalesOrder, ibas.IConvertedData {
            ...
            get documentTaxTotal(): number {
                return this.getProperty<number>(SalesOrder.PROPERTY_DOCUMENTTAXTOTAL_NAME);
            }
            /** 设置-单据税总计 */
            set documentTaxTotal(value: number) {
                this.setProperty(SalesOrder.PROPERTY_DOCUMENTTAXTOTAL_NAME, value);
            }
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new ibas.BusinessRuleSummation(
                        SalesOrder.PROPERTY_DOCUMENTTAXTOTAL_NAME, SalesOrder.PROPERTY_ITEMSTAXTOTAL_NAME, SalesOrder.PROPERTY_SHIPPINGSTAXTOTAL_NAME),
                    // 单据总计 = 行总计 + 运输费用
                    new ibas.BusinessRuleSummation(
                        SalesOrder.PROPERTY_DOCUMENTTOTAL_NAME, SalesOrder.PROPERTY_DISCOUNTTOTAL_NAME, SalesOrder.PROPERTY_SHIPPINGSEXPENSETOTAL_NAME),
                    // 小数舍入（单据总计）
            ...
            afterParsing(): void {
                ...
                for (let rule of ibas.businessRulesManager.getRules(ibas.objects.typeOf(this))) {
                    if (rule instanceof ibas.BusinessRuleSumElements) {
                        ...
                        && rule.result === SalesOrder.PROPERTY_DOCUMENTTAXTOTAL_NAME) {
                        rule.execute(this);
                    }
                }
            }
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionDiscountPrice(
                        SalesOrderItem.PROPERTY_DISCOUNT_NAME, SalesOrderItem.PROPERTY_UNITPRICE_NAME, SalesOrderItem.PROPERTY_PRICE_NAME
                    ...
                    new ibas.BusinessRuleSubtraction(
                        SalesOrderItem.PROPERTY_TAXTOTAL_NAME, SalesOrderItem.PROPERTY_LINETOTAL_NAME, SalesOrderItem.PROPERTY_PRETAXLINETOTAL_NAME),
                ];
            }
            /** 重置 */
            reset(): void {
