...
@XmlType(name = SalesQuoteItemExtra.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class SalesQuoteItemExtra extends BusinessObject<SalesQuoteItemExtra> implements ISalesQuoteItemExtra {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 2154559289376259716L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SalesQuoteItemExtra.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_QUT11";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SalesQuoteItemExtra";
