...
public class SalesQuoteItem extends BusinessObject<SalesQuoteItem>
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SalesQuoteItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_QUT1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SalesQuoteItem";
	...
	public IBusinessLogicContract[] getContracts() {
		...
		contracts.add(new ITaxGroupCheckContract() {
			...
			public String getTax() {
				return SalesQuoteItem.this.getTax();
			}

			@Override
			public BigDecimal getTaxRate() {
				return SalesQuoteItem.this.getTaxRate();
			}
		});
		// 物料及仓库检查
