 ...
 * 
 */
public interface ISalesCreditNoteItem extends IBODocumentLine, IMaterialBatchIssueParent, IMaterialSerialIssueParent {
	 ...
	 * @param value 值
	 */
	void setBasisQuantity(BigDecimal value);
