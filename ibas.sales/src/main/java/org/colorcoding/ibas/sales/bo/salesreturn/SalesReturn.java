...
@XmlType(name = SalesReturn.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = SalesReturn.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@BOCode(SalesReturn.BUSINESS_OBJECT_CODE)
public class SalesReturn extends BusinessObject<SalesReturn> implements ISalesReturn {
