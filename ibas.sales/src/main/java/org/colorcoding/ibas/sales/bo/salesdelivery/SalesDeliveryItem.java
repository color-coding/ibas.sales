		...
		return new IBusinessLogicContract[] {
				...
				new ITaxGroupCheckContract() {
					...
					public String getTax() {
						return SalesDeliveryItem.this.getTax();
					}

					@Override
					public BigDecimal getTaxRate() {
						return SalesDeliveryItem.this.getTaxRate();
					}
				},
				// 物料及仓库检查
				...
				new IMaterialCatalogCheckContract() {
					...
					public void setCatalogCode(String value) {
						SalesDeliveryItem.this.setCatalogCode(value);
					}
					...
					public String getCatalogCode() {
						return SalesDeliveryItem.this.getCatalogCode();
					}
					...
					public String getBusinessPartnerCode() {
						return SalesDeliveryItem.this.parent.getCustomerCode();
					}
				},
				// 物料发货
				new IMaterialIssueContract() {
					...
					public boolean isOffsetting() {
						...
						if (SalesDeliveryItem.this instanceof IBOTagDeleted) {
							IBOTagDeleted boTag = (IBOTagDeleted) SalesDeliveryItem.this;
						...
						if (SalesDeliveryItem.this.parent instanceof IBOTagDeleted) {
							IBOTagDeleted boTag = (IBOTagDeleted) SalesDeliveryItem.this.parent;
							if (boTag.getDeleted() == emYesNo.YES) {
								return true;
							}
						}
						if (SalesDeliveryItem.this.parent instanceof IApprovalData) {
							IApprovalData apData = (IApprovalData) SalesDeliveryItem.this.parent;
					...
					public BigDecimal getPrice() {
						...
						return Decimals.divide(SalesDeliveryItem.this.getPreTaxPrice(),
								SalesDeliveryItem.this.getUOMRate(), Decimals.DECIMAL_PLACES_STORAGE);
					}
				...
				new IBlanketAgreementQuantityContract() {
					...
					public BigDecimal getAmount() {
						// 一揽子协议金额按不含税口径
						return SalesDeliveryItem.this.getPreTaxLineTotal();
					}
