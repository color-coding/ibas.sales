...
public class SalesInvoice extends BusinessObject<SalesInvoice>
	 ...
	 * 属性名称-销售发票-行
	 */
	private static final String PROPERTY_SALESDELIVERYITEMS_NAME = "SalesInvoiceItems";

	/**
	 * 销售发票-行的集合属性
	 * 
	 */
	public static final IPropertyInfo<ISalesInvoiceItems> PROPERTY_SALESDELIVERYITEMS = registerProperty(
			PROPERTY_SALESDELIVERYITEMS_NAME, ISalesInvoiceItems.class, MY_CLASS);
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] {
				...
				new BusinessRuleSumElements(PROPERTY_ITEMSLINETOTAL, PROPERTY_SALESDELIVERYITEMS,
						SalesInvoiceItem.PROPERTY_LINETOTAL), // 计算项目-行总计
