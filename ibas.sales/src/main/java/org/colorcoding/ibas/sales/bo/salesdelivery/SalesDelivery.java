...
public class SalesDelivery extends BusinessObject<SalesDelivery>
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -6887865566369799094L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SalesDelivery.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_ODLN";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SalesDelivery";
	 ...
	 * 属性名称-销售交货-行
	 */
	private static final String PROPERTY_SALESDELIVERYITEMS_NAME = "SalesDeliveryItems";

	/**
	 * 销售交货-行的集合属性
	 * 
	 */
	public static final IPropertyInfo<ISalesDeliveryItems> PROPERTY_SALESDELIVERYITEMS = registerProperty(
			PROPERTY_SALESDELIVERYITEMS_NAME, ISalesDeliveryItems.class, MY_CLASS);
	...
	@XmlElement(name = SalesDeliveryItem.BUSINESS_OBJECT_NAME, type = SalesDeliveryItem.class)
	public final ISalesDeliveryItems getSalesDeliveryItems() {
	 ...
	 * @param value 值
	 */
	public final void setSalesDeliveryItems(ISalesDeliveryItems value) {
	...
	protected void initialize() {
		...
		this.setSalesDeliveryItems(new SalesDeliveryItems(this));
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] {
				...
				new BusinessRuleDocumentStatus(PROPERTY_DOCUMENTSTATUS, PROPERTY_SALESDELIVERYITEMS,
						SalesDeliveryItem.PROPERTY_LINESTATUS), // 使用集合元素状态
				// 计算行-总计（含税）
				new BusinessRuleSumElements(PROPERTY_ITEMSLINETOTAL, PROPERTY_SALESDELIVERYITEMS,
						SalesDeliveryItem.PROPERTY_LINETOTAL, new Predicate<SalesDeliveryItem>() {
							@Override
							public boolean test(SalesDeliveryItem t) {
								// 过滤，标记删除
		...
		return new IBusinessLogicContract[] {
				...
				new ICustomerCheckContract() {
					...
					public String getIdentifiers() {
						return SalesDelivery.this.getIdentifiers();
					}

					@Override
					public String getCustomerCode() {
						return SalesDelivery.this.getCustomerCode();
					}

					@Override
					public String getCustomerName() {
						return SalesDelivery.this.getCustomerName();
					}

					@Override
					public void setCustomerName(String value) {
						SalesDelivery.this.setCustomerName(value);
					}
				},
				// 分支检查
				new IBranchCheckContract() {
					...
					public String getBranch() {
						return SalesDelivery.this.getBranch();
					}
				},
				// 创建分录
				new IJournalEntryCreationContract() {
					...
					public String getBaseDocumentType() {
						return SalesDelivery.this.getObjectCode();
					}

					@Override
					public Integer getBaseDocumentEntry() {
						return SalesDelivery.this.getDocEntry();
					}

					@Override
					public DateTime getDocumentDate() {
						return SalesDelivery.this.getDocumentDate();
					}

					@Override
					public String getReference1() {
						return SalesDelivery.this.getReference1();
					}

					@Override
					public String getReference2() {
						return SalesDelivery.this.getReference2();
					}
	...
	public Iterator<IDocumentClosingQuantityItem> getQuantityItems() {
		return new Iterator<IDocumentClosingQuantityItem>() {
			...
			public boolean hasNext() {
				if (SalesDelivery.this.getSalesDeliveryItems().isEmpty()) {
					return false;
				}
				int nIndex = this.index + 1;
				if (nIndex >= SalesDelivery.this.getSalesDeliveryItems().size()) {
					return false;
				}
				return true;
			}
