...
public class SalesOrderItem extends BusinessObject<SalesOrderItem>
	 ...
	 * 已订购数量 属性
	 */
	@DbField(name = "OrderedQty", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
	...
	public IBusinessLogicContract[] getContracts() {
		...
		contracts.add(new ITaxGroupCheckContract() {
			...
			public String getTax() {
				return SalesOrderItem.this.getTax();
			}

			@Override
			public BigDecimal getTaxRate() {
				return SalesOrderItem.this.getTaxRate();
			}
		});
		// 物料及仓库检查
		...
		contracts.add(new IMaterialCatalogCheckContract() {
			...
			public void setCatalogCode(String value) {
				SalesOrderItem.this.setCatalogCode(value);
			}
			...
			public String getCatalogCode() {
				return SalesOrderItem.this.getCatalogCode();
			}
			...
			public String getBusinessPartnerCode() {
				return SalesOrderItem.this.parent.getCustomerCode();
			}
		});
		// 物料已承诺数量
		contracts.add(new IMaterialCommitedJournalContract() {
			...
			public BigDecimal getQuantity() {
				return Decimals.multiply(SalesOrderItem.this.getQuantity(), SalesOrderItem.this.getUOMRate());
			}

			@Override
			public BigDecimal getClosedQuantity() {
				return Decimals.multiply(SalesOrderItem.this.getClosedQuantity(), SalesOrderItem.this.getUOMRate());
			}
