...
@XmlType(name = SpecificationItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class SpecificationItem extends BusinessObject<SpecificationItem> implements ISpecificationItem {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 3933420040945259381L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SpecificationItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_SPC1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SpecificationItem";
	 ...
	 * 
	 */
	public static final IPropertyInfo<ISpecificationItemValues> PROPERTY_SPECIFICATIONITEMVALUES = registerProperty(
			PROPERTY_SPECIFICATIONITEMVALUES_NAME, ISpecificationItemValues.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_SPECIFICATIONITEMVALUES_NAME)
	@XmlElement(name = SpecificationItemValue.BUSINESS_OBJECT_NAME, type = SpecificationItemValue.class)
	public final ISpecificationItemValues getSpecificationItemValues() {
		return this.getProperty(PROPERTY_SPECIFICATIONITEMVALUES);
	}
	 ...
	 *            值
	 */
	public final void setSpecificationItemValues(ISpecificationItemValues value) {
		this.setProperty(PROPERTY_SPECIFICATIONITEMVALUES, value);
	}
	...
	protected void initialize() {
		...
		this.setSpecificationItemValues(new SpecificationItemValues(this));
