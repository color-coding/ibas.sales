...
@XmlType(name = ProductSpecificationItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class ProductSpecificationItem extends BusinessObject<ProductSpecificationItem>
		implements IProductSpecificationItem {
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ProductSpecificationItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_PDC1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ProductSpecificationItem";
