...
public class SalesQuote extends BusinessObject<SalesQuote>
		implements ISalesQuote, IDataOwnership, IApprovalData, IBusinessLogicsHost, IProjectData, IBOSeriesKey,
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SalesQuote.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_OQUT";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SL_SALESQUOTE";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SalesQuote";
	 ...
	 * 
	 */
	public static final IPropertyInfo<ISalesQuoteItems> PROPERTY_SALESQUOTEITEMS = registerProperty(
			PROPERTY_SALESQUOTEITEMS_NAME, ISalesQuoteItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_SALESQUOTEITEMS_NAME)
	@XmlElement(name = SalesQuoteItem.BUSINESS_OBJECT_NAME, type = SalesQuoteItem.class)
	public final ISalesQuoteItems getSalesQuoteItems() {
		return this.getProperty(PROPERTY_SALESQUOTEITEMS);
	}
		...
		if (this.getCustomerType() == emBusinessPartnerType.LEAD) {
			...
			contracts.add(new ILeadCheckContract() {
				...
				public String getLeadName() {
					return SalesQuote.this.getCustomerName();
				}

				@Override
				public void setLeadName(String value) {
					SalesQuote.this.setCustomerName(value);
				}
			});
