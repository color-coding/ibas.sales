...
@XmlType(name = SalesReserveInvoiceItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class SalesReserveInvoiceItem extends BusinessObject<SalesReserveInvoiceItem>
		implements ISalesReserveInvoiceItem, IBusinessLogicsHost, IBOTagDeleted, IBOTagCanceled, IBOUserFields,
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SalesReserveInvoiceItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_RIV1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SalesReserveInvoiceItem";
		...
		return new IBusinessLogicContract[] {
				...
				new IMaterialCatalogCheckContract() {
					...
					public void setCatalogCode(String value) {
						SalesReserveInvoiceItem.this.setCatalogCode(value);
					}
					...
					public String getCatalogCode() {
						return SalesReserveInvoiceItem.this.getCatalogCode();
					}
					...
					public String getBusinessPartnerCode() {
						return SalesReserveInvoiceItem.this.parent.getCustomerCode();
					}
				},
				// 一揽子协议
				new IBlanketAgreementQuantityContract() {
					...
					public BigDecimal getQuantity() {
						return SalesReserveInvoiceItem.this.getQuantity();
					}
					...
					public String getBaseDocumentType() {
						return SalesReserveInvoiceItem.this.getBaseDocumentType();
					}

					@Override
					public Integer getBaseDocumentEntry() {
						return SalesReserveInvoiceItem.this.getBaseDocumentEntry();
					}
