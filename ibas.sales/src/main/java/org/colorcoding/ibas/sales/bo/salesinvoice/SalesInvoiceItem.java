...
import org.colorcoding.ibas.sales.logic.ISalesDeliveryInvoiceContract;
...
public class SalesInvoiceItem extends BusinessObject<SalesInvoiceItem>
		implements ISalesInvoiceItem, IBusinessLogicsHost, IBOTagDeleted, IBOTagCanceled, IBOUserFields {
