...
@XmlType(name = SalesInvoiceItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class SalesInvoiceItem extends BusinessObject<SalesInvoiceItem> implements ISalesInvoiceItem,
		IBusinessLogicsHost, IBOTagDeleted, IBOTagCanceled, IBOUserFields, IJECPropertyValueGetter {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 1948113772084820043L;
	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SalesInvoiceItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_INV1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SalesInvoiceItem";
	...
	public IBusinessLogicContract[] getContracts() {
		...
		contracts.add(new ITaxGroupCheckContract() {
			...
			public String getTax() {
				return SalesInvoiceItem.this.getTax();
			}

			@Override
			public BigDecimal getTaxRate() {
				return SalesInvoiceItem.this.getTaxRate();
			}
		});
		// 物料及仓库检查
		...
		contracts.add(new IMaterialCatalogCheckContract() {
			...
			public void setCatalogCode(String value) {
				SalesInvoiceItem.this.setCatalogCode(value);
			}
			...
			public String getCatalogCode() {
				return SalesInvoiceItem.this.getCatalogCode();
			}
			...
			public String getBusinessPartnerCode() {
				return SalesInvoiceItem.this.parent.getCustomerCode();
			}
		});
		// 基于单据完成数量
		...
		if (!MyConfiguration.applyVariables(SalesDelivery.BUSINESS_OBJECT_CODE)
			...
			contracts.add(new IMaterialIssueContract() {
				...
				public boolean isOffsetting() {
					...
					if (SalesInvoiceItem.this.parent instanceof IApprovalData) {
						IApprovalData apData = (IApprovalData) SalesInvoiceItem.this.parent;
				...
				public String getItemName() {
					return SalesInvoiceItem.this.getItemDescription();
				}
				...
				public String getDocumentType() {
					return SalesInvoiceItem.this.getObjectCode();
				}

				@Override
				public Integer getDocumentEntry() {
					return SalesInvoiceItem.this.getDocEntry();
				}

				@Override
				public Integer getDocumentLineId() {
					return SalesInvoiceItem.this.getLineId();
				}

				@Override
				public BigDecimal getQuantity() {
					return SalesInvoiceItem.this.getInventoryQuantity();
				}

				@Override
				public String getUOM() {
					return SalesInvoiceItem.this.getInventoryUOM();
				}

				@Override
				public DateTime getPostingDate() {
					return SalesInvoiceItem.this.parent.getPostingDate();
				}

				@Override
				public DateTime getDeliveryDate() {
					return SalesInvoiceItem.this.parent.getDeliveryDate();
				}

				@Override
				public DateTime getDocumentDate() {
					return SalesInvoiceItem.this.parent.getDocumentDate();
				}
				...
				public BigDecimal getPrice() {
					...
					return Decimals.divide(SalesInvoiceItem.this.getPreTaxPrice(), SalesInvoiceItem.this.getUOMRate(),
