...
import org.colorcoding.ibas.sales.logic.ISalesReturnCreditNoteContract;
...
public class SalesCreditNoteItem extends BusinessObject<SalesCreditNoteItem>
		implements ISalesCreditNoteItem, IBusinessLogicsHost, IBOTagDeleted, IBOTagCanceled, IBOUserFields {
	...
	public IBusinessLogicContract[] getContracts() {
		...
		if (MyConfiguration.applyVariables(SalesReturn.BUSINESS_OBJECT_CODE)
			...
			return new IBusinessLogicContract[] {
					// 销售退货贷项
					new ISalesReturnCreditNoteContract() {
