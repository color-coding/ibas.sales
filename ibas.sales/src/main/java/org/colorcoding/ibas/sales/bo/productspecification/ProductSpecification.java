...
@XmlType(name = ProductSpecification.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = ProductSpecification.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BOCode(ProductSpecification.BUSINESS_OBJECT_CODE)
public class ProductSpecification extends BusinessObject<ProductSpecification>
		implements IProductSpecification, IDataOwnership, IApprovalData, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -5289704033847003562L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ProductSpecification.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_OPDC";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SL_PDSPEC";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ProductSpecification";
	 ...
	 * 属性名称-产品规格-项目
	 */
	private static final String PROPERTY_PRODUCTSPECIFICATIONITEMS_NAME = "ProductSpecificationItems";

	/**
	 * 产品规格-项目的集合属性
	 * 
	 */
	public static final IPropertyInfo<IProductSpecificationItems> PROPERTY_PRODUCTSPECIFICATIONITEMS = registerProperty(
			PROPERTY_PRODUCTSPECIFICATIONITEMS_NAME, IProductSpecificationItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_PRODUCTSPECIFICATIONITEMS_NAME)
	@XmlElement(name = ProductSpecificationItem.BUSINESS_OBJECT_NAME, type = ProductSpecificationItem.class)
	public final IProductSpecificationItems getProductSpecificationItems() {
		return this.getProperty(PROPERTY_PRODUCTSPECIFICATIONITEMS);
	}
	 ...
	 *            值
	 */
	public final void setProductSpecificationItems(IProductSpecificationItems value) {
		this.setProperty(PROPERTY_PRODUCTSPECIFICATIONITEMS, value);
	}
	...
	protected void initialize() {
		...
		this.setProductSpecificationItems(new ProductSpecificationItems(this));
