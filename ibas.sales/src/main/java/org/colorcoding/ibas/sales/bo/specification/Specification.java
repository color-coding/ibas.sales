...
@XmlType(name = Specification.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Specification.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BOCode(Specification.BUSINESS_OBJECT_CODE)
public class Specification extends BusinessObject<Specification>
		implements ISpecification, IDataOwnership, IApprovalData, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 8559319254556333896L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Specification.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_OSPC";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SL_SPEC";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Specification";
	 ...
	 * 属性名称-目标类型
	 */
	private static final String PROPERTY_TARGETTYPE_NAME = "TargetType";

	/**
	 * 目标类型 属性
	 */
	@DbField(name = "TargetType", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	public static final IPropertyInfo<emSpecificationTarget> PROPERTY_TARGETTYPE = registerProperty(
			PROPERTY_TARGETTYPE_NAME, emSpecificationTarget.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_TARGETTYPE_NAME)
	public final emSpecificationTarget getTargetType() {
		return this.getProperty(PROPERTY_TARGETTYPE);
	}
	 ...
	 *            值
	 */
	public final void setTargetType(emSpecificationTarget value) {
		this.setProperty(PROPERTY_TARGETTYPE, value);
	}
	 ...
	 * 属性名称-规格模板-项目
	 */
	private static final String PROPERTY_SPECIFICATIONITEMS_NAME = "SpecificationItems";

	/**
	 * 规格模板-项目的集合属性
	 * 
	 */
	public static final IPropertyInfo<ISpecificationItems> PROPERTY_SPECIFICATIONITEMS = registerProperty(
			PROPERTY_SPECIFICATIONITEMS_NAME, ISpecificationItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_SPECIFICATIONITEMS_NAME)
	@XmlElement(name = SpecificationItem.BUSINESS_OBJECT_NAME, type = SpecificationItem.class)
	public final ISpecificationItems getSpecificationItems() {
		return this.getProperty(PROPERTY_SPECIFICATIONITEMS);
	}
	 ...
	 *            值
	 */
	public final void setSpecificationItems(ISpecificationItems value) {
		this.setProperty(PROPERTY_SPECIFICATIONITEMS, value);
	}
	...
	protected void initialize() {
		...
		this.setSpecificationItems(new SpecificationItems(this));
