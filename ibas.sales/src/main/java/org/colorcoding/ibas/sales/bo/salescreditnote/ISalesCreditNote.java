 ...
 * 
 */
public interface ISalesCreditNote extends IBODocument, IShippingAddressParent {
	/**
	 * 获取-凭证编号
	 * 
	 * @return 值
	...
	*/
	 ...
	 * @return 值
	 */
	ISalesCreditNoteItems getSalesCreditNoteItems();
	 ...
	 * @param value 值
	 */
	void setSalesCreditNoteItems(ISalesCreditNoteItems value);
