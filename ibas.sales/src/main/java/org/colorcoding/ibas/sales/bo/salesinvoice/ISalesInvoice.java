 ...
 * 
 */
public interface ISalesInvoice extends IBODocument, IShippingAddressParent {
	...
	*/
	 ...
	 * @return 值
	 */
	ISalesInvoiceItems getSalesInvoiceItems();
	 ...
	 * @param value 值
	 */
	void setSalesInvoiceItems(ISalesInvoiceItems value);
