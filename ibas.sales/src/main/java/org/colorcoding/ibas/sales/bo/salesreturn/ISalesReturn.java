 ...
 * 
 */
public interface ISalesReturn extends IBODocument, IShippingAddressParent {
	 ...
	 * @return 值
	 */
	ISalesReturnItems getSalesReturnItems();
	 ...
	 * @param value 值
	 */
	void setSalesReturnItems(ISalesReturnItems value);
