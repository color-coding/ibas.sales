...
@XmlType(name = SalesOrderItemExtra.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class SalesOrderItemExtra extends BusinessObject<SalesOrderItemExtra> implements ISalesOrderItemExtra {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 8370740241138613734L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SalesOrderItemExtra.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_RDR11";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SalesOrderItemExtra";
