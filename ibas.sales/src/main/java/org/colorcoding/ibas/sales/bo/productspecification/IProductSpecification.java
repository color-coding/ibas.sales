...
* 
*/
public interface IProductSpecification extends IBOSimple {
    ...
    * @return 值
    */
    IProductSpecificationItems getProductSpecificationItems();
    ...
    * @param value 值
    */
    void setProductSpecificationItems(IProductSpecificationItems value);
