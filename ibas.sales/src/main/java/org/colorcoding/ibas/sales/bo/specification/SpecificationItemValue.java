...
@XmlType(name = SpecificationItemValue.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class SpecificationItemValue extends BusinessObject<SpecificationItemValue> implements ISpecificationItemValue {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 5785481368111348987L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = SpecificationItemValue.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SL_SPC2";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "SpecificationItemValue";
