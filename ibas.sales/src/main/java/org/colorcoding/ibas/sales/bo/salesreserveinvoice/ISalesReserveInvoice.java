...
import org.colorcoding.ibas.sales.bo.shippingaddress.IShippingAddressParent;
 ...
 * 
 */
public interface ISalesReserveInvoice extends IBODocument, IShippingAddressParent {
	...
	*/
	 ...
	 * @return 值
	 */
	ISalesReserveInvoiceItems getSalesReserveInvoiceItems();
	 ...
	 * @param value 值
	 */
	void setSalesReserveInvoiceItems(ISalesReserveInvoiceItems value);
