 ...
 * 销售交货-批次 集合
 */
@XmlType(name = SalesDeliveryItemMaterialBatchJournals.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlSeeAlso({ MaterialBatchJournal.class })
public class SalesDeliveryItemMaterialBatchJournals extends BusinessObjects<IMaterialBatchJournal,ISalesDeliveryItem> implements ISalesDeliveryItemMaterialBatchJournals {
    /**
     * 业务对象名称
     */
    public static final String BUSINESS_OBJECT_NAME = "SalesDeliveryItemMaterialBatchJournals";
    ...
    public SalesDeliveryItemMaterialBatchJournals(){super();}

    /**
     * 构造方法
     * @param parent 父项对象
     */
    public SalesDeliveryItemMaterialBatchJournals(ISalesDeliveryItem parent) {
        super(parent);
    }
